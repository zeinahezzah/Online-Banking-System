...
prx.types.shape = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (typeof item.lineHeight == "undefined") {
      item.lineHeight = parseInt(
        prx.componentsHelper.getProp(item.textSize, "num-text-size") * 1.231
      );
    }
    ...
    var cR =
      ...
      " box pos type-shapes " +
      prx.componentsHelper.getProp(item.typeName, "other") +
      '" data-shape-type="' +
      prx.componentsHelper.getProp(item.typeName, "other") +
      '" ';
    cR +=
      'data-border-width-shape="' +
      prx.componentsHelper.getProp(item.borderWidthShape, "border-width") +
      '" data-num-nodes="' +
      prx.componentsHelper.getProp(item.numOfNodes, "numOfNodes") +
      '" data-spike-depth="' +
      prx.componentsHelper.getProp(item.spikeDepth, "spikeDepth") +
      '" ';
    cR +=
      'data-skew="' +
      prx.componentsHelper.getProp(item.skew, "skew") +
      '" data-base-width="' +
      prx.componentsHelper.getProp(item.baseWidth, "baseWidth") +
      '">';
    ...
    cR +=
      "#" +
      _id +
      " .shapes-text-container { width: 100%; height: 100%; " +
      _props +
      " " +
      ...
      "; line-height: " +
      prx.componentsHelper.getProp(item.lineHeight, "num-text-size") +
      "px; letter-spacing: " +
      prx.componentsHelper.getProp(item.textSpacing, "num-text-size") +
      "px;  }";
    ...
    cR +=
      ...
      " " +
      dims.height +
      '" width="100%" height="100%" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" version="1.1">';

    if (
      prx.componentsHelper.getProp(item.typeName, "other") == "polygon" ||
      prx.componentsHelper.getProp(item.typeName, "other") == "star"
    ) {
      path = prx.componentsHelper.drawComplexShape(
        item,
        prx.componentsHelper.getProp(item.typeName, "other"),
        dims.width,
        dims.height,
        prx.componentsHelper.getProp(item.borderWidthShape, "num-border-width")
      );
    } else {
      path = prx.componentsHelper.drawShape(
        item,
        prx.componentsHelper.getProp(item.typeName, "other"),
        dims.width,
        dims.height,
    ...
    cR +=
      ...
      '" id="path-' +
      _id +
      '" class="liveUpdate-backgroundColor-fill liveUpdate-borderColor-stroke changeProperty-backgroundColor changeProperty-backgroundColor-fill changeProperty-borderColor-stroke"';
    ...
    cR +=
      ...
      prx.componentsHelper.getProp(item.borderWidthShape, "num-border-width") +
      "px; stroke-linejoin:" +
      prx.componentsHelper.getProp(item.joinType, "other") +
      "; stroke-miterlimit:" +
      prx.componentsHelper.getProp(item.borderWidthShape, "num-border-width") +
      ';" />';
  ...
  onResize: function (item, containerid, symbol) {
    ...
    document
      .getElementById("svg-" + _id)
      .setAttribute("viewBox", "0 0 " + dims.width + " " + dims.height);
    ...
    if (
      ...
      document
        .getElementById("path-" + _id)
        .setAttribute(
          "d",
          prx.componentsHelper.drawComplexShape(
            item,
            prx.componentsHelper.getProp(item.typeName, "other"),
            dims.width,
            dims.height,
            prx.componentsHelper.getProp(
              item.borderWidthShape,
              "num-border-width"
            )
          )
        );
      ...
      document
        ...
        .setAttribute(
          "d",
          prx.componentsHelper.drawShape(
            item,
            prx.componentsHelper.getProp(item.typeName, "other"),
            dims.width,
            dims.height,
        ...
        [
          {
            ...
            onChange: function (item, name) {
              if (item.typeName == "rectangle" || item.typeName == "oval") {
                switch (true) {
                  case item.typeName == "oval" &&
                    typeof item.borderWidth != "undefined" &&
                    typeof item.borderWidth == "object":
                    item.borderWidth = item.borderWidth.t;
                    break;
                  case typeof item.borderWidth == "undefined" &&
                    typeof item.borderWidthShape == "undefined":
                    item.borderWidth = 0;
                    break;
                  case typeof item.borderWidth == "undefined" &&
                    typeof item.borderWidthShape != "undefined":
...
prx.types.symbol = {
  name: "symbol",
  onDisplay: function (item, containerid, symbol) {
    var isAppleWatchCrown =
      (typeof prx.devices[prx.device] != "undefined" &&
        prx.devices[prx.device].scrollType == "crown") ||
      (typeof prx.deviceExtraParams != "undefined" &&
        prx.deviceExtraParams.scrollType == "crown")
        ? true
        : false;
    var _id = !containerid ? item.id : containerid + "-" + item.id;
    var _symbolindex = prx.stc.containers.getIndexFromId(
      prx.componentsHelper.getProp(item.symbolid, "other")
    );
    ...
    if (prx.editor) {
      if (prx.componentsHelper.getProp(item.scroll, "other") == "omni") {
        ...
        prx.componentsHelper.getProp(item.scroll, "other") == "vertical"
      ) {
        cReturn += "#" + _id + "-scroll { top: -" + item.scrollToY + "px; }";
      } else if (
        prx.componentsHelper.getProp(item.scroll, "other") == "horizontal"
      ) {
    ...
    if (_symbolindex > -1) {
      ...
      if (typeof prxy.symbols[_symbolindex].states == "undefined") {
        ...
        if (typeof item.symbolstateid != "undefined") {
          stateindex = prx.stc.containers.getStateIndexFromId(
            prx.componentsHelper.getProp(item.symbolstateid, "other"),
            prx.stc.containers.getIndexFromId(
              prx.componentsHelper.getProp(item.symbolid, "other")
            )
          );
          if (stateindex == -1) {
            stateindex = 0;
            item.symbolstateid =
              prxy.symbols[_symbolindex].states[stateindex].id;
          }
        }
        var _bg = prxy.symbols[_symbolindex].states[stateindex].background;
        _symbol_width =
          prxy.symbols[_symbolindex].states[stateindex].dimensions[0] + "px";
        _symbol_height =
          prxy.symbols[_symbolindex].states[stateindex].dimensions[1] + "px";
        var dataState =
          'data-state-id="' +
          prxy.symbols[_symbolindex].states[stateindex].id +
          '"';
      ...
      if (prx.componentsHelper.getProp(item.scroll, "other") != "") {
        ...
        if (
          ...
          if (typeof prxy.symbols[_symbolindex].dimensions != "undefined") {
            ...
            _symbol_height =
              prxy.symbols[_symbolindex].states[stateindex].dimensions[1] +
              "px";
          }
        }
      }
      ...
      var osWatchStyle =
        prx.componentsHelper.getProp(item.scroll, "other") == "vertical" &&
        typeof item.watchOSscrollbars !== "undefined" &&
        prx.componentsHelper.getProp(item.watchOSscrollbars, "boolean") == true
          ? true
          : false;
      ...
      cReturn +=
        '<div id="' +
        _id +
        '" class="box type-symbol ' +
        prx.items.getComponentBaseClasses(item, containerid, symbol) +
        " " +
        (prx.componentsHelper.getProp(item.propagateevents, "boolean") &&
        (prx.componentsHelper.getProp(item.scroll, "other") == "" ||
          prx.componentsHelper.getProp(item.scroll, "other") == "none")
          ? "type-symbol-transparent"
          : "") +
        " scroll-" +
        prx.componentsHelper.getProp(item.scroll, "other") +
        '" data-symbol-id="' +
      ...
      if (
        prx.componentsHelper.getProp(isAppleWatchCrown, "boolean") == true &&
        osWatchStyle == true
      ) {
        ...
        if (
          prx.devices[prx.device]["portrait"][0] == appleWatch38mmWH[0] &&
          prx.devices[prx.device]["portrait"][1] == appleWatch38mmWH[1]
        ) {
          cssTop = 35;
          cssLeft = 259;
        } else if (
          prx.devices[prx.device]["portrait"][0] == appleWatch42mmWH[0] &&
          prx.devices[prx.device]["portrait"][1] == appleWatch42mmWH[1]
        ) {
          cssTop = 53;
          cssLeft = 299;
        } else if (
          prx.devices[prx.device]["portrait"][0] == appleWatch40mmWH[0] &&
          prx.devices[prx.device]["portrait"][1] == appleWatch40mmWH[1]
        ) {
          cssTop = 60;
          cssLeft = 312;
        } else {
        ...
        var scrollbarIndicatorHeight = Math.max(
          Math.round(
            (item.height / parseInt(_symbol_height)) * scrollbarWrapperHeight
          ),
          15
        );
        cReturn += "<style>";
        cReturn +=
          "#" +
          _id +
          " .iScrollVerticalScrollbar {height:" +
          scrollbarWrapperHeight +
          "px!important;top:" +
          cssTop +
          "px!important;right:0!important;left: " +
          cssLeft +
          "px!important}";
        cReturn +=
          "#" +
          _id +
          " .iScrollIndicator {height:" +
          scrollbarIndicatorHeight +
          "px!important;}";
        cReturn += "</style>";
      }
      cReturn += "<style>";
      ...
      cReturn +=
        ...
        _id +
        '-inner" class="' +
        applewatchScrollbarClass +
        '" style="position: absolute; overflow: hidden !important; height: 100%; width: 100%;">';
      cReturn +=
        '<div id="' +
        _id +
        '-scroll" class="symbol-scroll" style="width: ' +
        _symbol_width +
        "; height: " +
        _symbol_height +
        "; position: absolute; overflow: hidden; background-color: " +
        prx.componentsHelper.getProp(_bg, "color-background") +
        ';">';
      ...
      if (prx.editor && symbol === undefined) {
        cReturn +=
          '<div class="type-symbol-hover-message">Double-click to edit container</div>';
      }
  ...
  afterDisplay: function (item, containerid, symbol, callback) {
    ...
    if (typeof item.symbolstateid != "undefined") {
      stateindex = prx.stc.containers.getStateIndexFromId(
        item.symbolstateid,
        prx.stc.containers.getIndexFromId(item.symbolid)
      );
      if (stateindex == -1) {
        stateindex = 0;
      }
    }
    prx.stc.containers.loadRecursiveAfterDisplay(
      item,
      containerid,
      stateindex,
      callback
  ...
  onResize: function (item, containerid, symbol) {
    ...
    if (_symbolindex > -1) {
      ...
      if (!prx.editor) {
        ...
        var tempstateindex = prx.stc.containers.getStateIndexFromId(
          stateid,
          _symbolindex
        );
        ...
        [
          {
            ...
            value: function (item, name) {
              if (
                typeof prxy.symbols[0] != "undefined" &&
                typeof prxy.symbols[0].states == "undefined"
              ) {
                return "";
              }
            ...
            values: function (item) {
              ...
              for (
                var i = 0;
                i <
                prxy.symbols[prx.stc.containers.getIndexFromId(item.symbolid)]
                  .states.length;
                i++
              ) {
                rA.push({
        ...
        [
          {
            ...
            onChange: function (item) {
              if (item.scroll == "" || item.scroll == "none") {
                $(
                  "#property-scrollsnap, #property-pinchzoom, #property-momentum, #property-scrollbars, #property-lockdirection, #property-bounce, #property-watchOSscrollbars, #property-scrollToX, #property-scrollToY"
                ).hide();
                $("#property-propagateevents").show();
              } else {
                $(
                  "#property-scrollsnap, #property-pinchzoom, #property-momentum, #property-bounce, #property-scrollbars"
                ).show();
        ...
        [
          ...
          },
          {
            ...
            value: function (item, name) {
              ...
              if (typeof _scrollbars == "undefined") {
                switch (item.scroll) {
                  case "omni":
                    _scrollbars =
                      eval(item.hscrollbar) || eval(item.vscrollbar)
                        ? true
                        : false;
                    break;
                  case "horizontal":
            ...
            onChange: function (item) {
              if (
                item.scroll == "vertical" &&
                prx.devices[prx.device].deviceType == "applewatch" &&
                (item.scrollbars == "FADE" || item.scrollbars == "ALWAYS")
              ) {
                $("#property-watchOSscrollbars").show();
              } else {
                $("#property-watchOSscrollbars").hide();
          ...
          },
          {
            ...
            values: {
              ...
              max: function (item) {
                ...
                let state =
                  symbol.states[
                    prx.stc.containers.getStateIndexFromId(item.symbolstateid)
                  ] || symbol.states[0];
              ...
              changeFunction: function (item, containerid, duration, easing) {
                ...
                if (scrollable !== undefined) {
                  if (scrollable.options.snap) {
                    var pageX = Math.floor(
                      Math.abs(item.scrollToX) / scrollable.wrapperWidth
                    );
                    var pageY = Math.floor(
                      Math.abs(item.scrollToY) / scrollable.wrapperHeight
                    );
                    ...
                    scrollable.goToPage(
                      ...
                      pageY,
                      duration * 1000,
                      prx.easing.getIScrollEasing(easing)
                    );
                  } else {
                    scrollable.scrollTo(
                      Math.abs(item.scrollToX) * -1,
                      Math.abs(item.scrollToY) * -1,
                      duration * 1000,
                      prx.easing.getIScrollEasing(easing)
                    );
                  }
    ...
    },
    {
      ...
      properties: [
        [
          {
            caption:
              "In empty areas, layers behind the container can be interacted with",
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (_symbolindex > -1) {
      ...
      cReturn +=
        '<div id="' +
        _id +
        '-inner" class="vrsymbol-inner" style="position: absolute; overflow: hidden !important; height: 100%; width: 100%;">';
      cReturn += prx.vr.render(item, containerid, stateindex, _symbolindex);
      cReturn += "</div>";
      if (prx.editor) {
        cReturn +=
          '<div class="type-vrsymbol-hover-message">Double-click to edit VR Scene</div>';
      }
      cReturn += prx.items.getComponentAppendDivs(item, containerid, symbol);
      cReturn += "</div>";
    } else {
...
prx.types.text = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var cR =
      ...
      (prx.componentsHelper.getProp(item.propagateEvents, "boolean")
        ? "pointer-events-none "
        : "") +
      "liveUpdate-textColor-color changeProperty-textColor changeProperty-textAlign changeProperty-lineHeight changeProperty-textSpacing " +
      (item.v2 !== undefined && item.v2 == true ? "v2-text " : "") +
      '" style="line-height: ' +
      prx.componentsHelper.getProp(item.lineHeight, "num-other") +
      "px; letter-spacing: " +
      prx.componentsHelper.getProp(item.textSpacing, "num-text-size") +
      "px; color: " +
      prx.componentsHelper.getProp(item.textColor, "color-text") +
    ...
    cR +=
      ...
      (prx.componentsHelper.getProp(item.autoResize, "boolean") == true
        ? " autoResize-true "
        : "") +
      ' liveUpdate-backgroundColor-background-color changeProperty-backgroundColor " style="' +
  ...
  onResize: function (item, containerid, symbol) {
    if (prx.editor) {
      ...
      let textareaIsActive =
        itemSelector.find("#editable-properties-text").length > 0
          ? true
          : false;

      if (
        $innerTextDivHeight === 0 &&
        textareaIsActive &&
        prxy.iSelectedIndex > -1
      ) {
  ...
  editableProperties: [
    {
      ...
      onChange: function (item, that, value) {
        ...
        if (prx.editor) {
          ...
          var _height = isNaN(parseInt($temp.css("line-height")))
            ? $temp.height()
            : Math.max(parseInt($temp.css("line-height")), $temp.height());
          ...
          if (isAutoResize) {
            var froalaEditor = $("#editable-properties-text").data(
              "froala.editor"
            );

            if (
              typeof froalaEditor != "undefined" &&
              typeof froalaEditor.textAlign != "undefined"
            ) {
          ...
          let _align =
            textAlign === "center" ? "n" : textAlign === "right" ? "ne" : "nw";
          ...
          $item.css({
            left: positionWithOffset.x,
            top: positionWithOffset.y,
            height: _height,
          });
  ...
  interactions: [
    {
      ...
      hiddenByDefault: function (item) {
        if (
          typeof item.propagateEvents != "undefined" &&
          item.propagateEvents
        ) {
          return true;
        }
        return false;
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              let _align =
                prxy.items[_index].textAlign === "center"
                  ? "n"
                  : prxy.items[_index].textAlign === "right"
                  ? "ne"
                  : "nw";
              ...
              var isRichTextEditorOpen =
                $(el).data("froala.editor") !== undefined ? true : false;
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              var _$item = $("#" + item.id + ' [data-editableproperty="text"]');
              var fontWeight = prx.componentsHelper.getProp(
                item.textFontStyle,
                "font-weight-value"
              );
              var fontStyle = prx.componentsHelper.getProp(
                item.textFontStyle,
                "font-style-value"
              );
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              if (isAutoResize) {
                ...
                $iframeRichTextEL.width(_width).height(_height);
                prxy.items[prx.items.helper.getIndexFromId(item.id)].width =
                  _width;
              } else {
                $item.height(_height);
                $iframeRichTextEL.width(item.width).height(_height);
        ...
        [
          {
            ...
            onClick: function (item) {
              if (
                item.text.indexOf(item.caption.replace("...", "")) == 0 ||
                /^Text(\s[0-9]*)?$/.test(item.caption)
              ) {
                item.caption = "Lorem ipsum dolor sit amet...";
                $("#itembrowser #id-" + item.id + " .item-caption").text(
                  item.caption
                );
              }
              item.text =
              ...
              var isAutoResize = item.autoResize == true ? true : false;
              var $item = $("#" + item.id);
              var canvasWidth = prx.stc.screens.check()
                ? Math.round(
                    prx.devices[prx.device][
                      prxy.pages[prxy.iSelectedPage].orientation
                    ][0]
                  )
                : Math.round(
                    prxy.symbols[prxy.iSelectedSymbol].states[
                      prxy.iSelectedState
                    ].dimensions[0]
                  );
              var canvasHeight = prx.stc.screens.check()
                ? Math.round(
                    prx.devices[prx.device][
                      prxy.pages[prxy.iSelectedPage].orientation
                    ][1]
              ...
              if (
                typeof prx.htmlTextEditor.currentEditorInstance !== "undefined"
              ) {
...
prx.types.rectangle = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      "#" +
      _id +
      " .shapes-image-background { " +
      (prx.componentsHelper.getProp(item.imgSrc, "asset") !== ""
        ? "background-image: url(" +
          prx.componentsHelper.getProp(item.imgSrc, "asset") +
          "); background-size: " +
          (prx.componentsHelper.getProp(item.backgroundSizeType, "text") ==
          "cover"
            ? prx.componentsHelper.getProp(item.backgroundSizeType, "text") +
              ";"
            : prx.componentsHelper.getProp(
                item.backgroundSizeValue,
                "num-percentage"
              ) + "% auto;")
        : "") +
      " border-radius: " +
    ...
    cR +=
      '<div id="rec-' +
      _id +
      '" class="inner-rec liveUpdate-backgroundColor-background-color changeProperty-borderRadius changeProperty-backgroundColor changeProperty-backgroundColor-background-color changeProperty-borderColor changeProperty-borderWidth changeProperty-borderColor-border-color liveUpdate-borderColor-border-color">';
    cR +=
      '<div class="shapes-image-background changeProperty-borderRadius"></div>';
    cR +=
      '<div class="shapes-text-container liveUpdate-textColor-color changeProperty-textFontStyle">';
    cR +=
      '<span data-editableproperty="text">' +
      prx.componentsHelper.getProp(item.text, "text-textarea") +
      "</span>";
    cR +=
      '<span class="fake-text hidden" style="position:absolute;">&nbsp;&nbsp;</span>'; //This element was added to resolve empty rectangle visibility issues when filter is applied on chromium based browsers.
    cR += "</div>";
    cR += "</div>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
...
prx.types.circle.propertyGroups = prx.componentsHelper.removeProperties(
  prx.types.circle.propertyGroups,
  ["borderRadius"]
);
prx.types.circle.propertyGroups = prx.componentsHelper.removePropertySetting(
  prx.types.circle.propertyGroups,
  "borderWidth",
  "expandableType"
);
...
prx.types.horizontalline = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var cR =
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-horizontalline" style="height: ' +
      prx.componentsHelper.getProp(item.weight, "num-other") +
      'px; overflow: visible">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR += "</style>";
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      '<div class="inner liveUpdate-color-border-color" style="border-top: ' +
      prx.componentsHelper.getProp(item.weight, "num-border-width") +
      "px " +
      prx.componentsHelper.getProp(item.borderStyle, "border-type") +
      " " +
      prx.componentsHelper.getProp(item.color, "color-border") +
      ';">';
    cR += "</div>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
...
prx.types.verticalline = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var cR =
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-verticalline" style="width: ' +
      prx.componentsHelper.getProp(item.weight, "num-other") +
      'px;">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    ...
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      '<div class="inner liveUpdate-color-border-color" style="border-left: ' +
      prx.componentsHelper.getProp(item.weight, "num-border-width") +
      "px " +
      prx.componentsHelper.getProp(item.borderStyle, "border-type") +
      " " +
...
prx.types.actionarea = {
  ...
  onDisplay: function (item, containerid, symbol) {
    var _id = !containerid ? item.id : containerid + "-" + item.id;
    let assistiveDescripionAttr = item.assistiveDescription
      ? 'role="button" aria-label="' +
        prx.utils.escapeHTML(item.assistiveDescription) +
        '"'
      : "";
    ...
    var cR =
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-actionarea" ' +
      assistiveDescripionAttr +
      ">";
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR += "</style>";
            ...
            onChange: function (item) {
              if (item.assistiveDescription !== "") {
                document
                  ...
                  .setAttribute("aria-label", item.assistiveDescription);
              }
            },
            changeProperty: {
...
prx.types.image = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    if (prx.editor) {
      ...
      if (
        prx.imageChecked[assetUrl] !== undefined &&
    ...
    let ariaAttribute = item.assistiveDescription
      ? 'role="img" aria-label="' +
        prx.utils.escapeHTML(item.assistiveDescription) +
        '"'
      : "";
    ...
    cR +=
      ...
      (prx.componentsHelper.getProp(item.propagateEvents, "boolean")
        ? "pointer-events-none"
        : "") +
      (prx.componentsHelper.getProp(item.repeat, "boolean")
        ? " type-image-repeater"
        : "") +
      '" ' +
    ...
    if (prx.mask.isActive(item))
      cR += prx.items.getComponentPrependDivs(
        item,
        containerid,
        symbol,
        thumbUrl2
    ...
    cR +=
      '<div class="image-inner borderPos-' +
      prx.componentsHelper.getProp(item.borderPos, "other") +
      '">';

    cR +=
      '<div id="' +
      _id +
      '-img-wrapper" class="type-image-wrapper liveUpdate-borderColor-border-color changeProperty-borderColor changeProperty-borderRadius changeProperty-borderWidth ' +
      (item.imgSrc.fileId !== undefined &&
      prx.componentsHelper.getProp(item.imgSrc.fileId.slice(-4), "other") ==
        ".svg"
        ? " type-image-svg"
        : "") +
      missingClass +
    ...
    cR +=
      ...
      '-img" src="' +
      (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") == ""
        ? 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" style="width:' +
          tempW +
          "px;height:" +
          tempH +
          'px"'
    ...
    if (
      prx.componentsHelper.getProp(item.imgSrc.fileId, "other") ==
        "d310bece0e91b91b485ed62166d1fc2e.svg" &&
      prx.componentsHelper.getProp(item.imgSrc.assetType, "other") == "gallery"
    ) {
      if (prx.editor) {
        cR +=
          '<div class="type-image-hover-message">Double-click to edit image</div>';
      }
      cR +=
        "<style>#" +
        _id +
        " .type-image-wrapper { background-color: #f9f9f9; }</style>";
    }
    ...
    cR +=
      ...
      ", #" +
      _id +
      " .type-image-wrapper { border-radius: " +
      prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
      ";}";
    cR +=
      "#" +
      _id +
      " .type-image-wrapper { border-width: " +
      prx.componentsHelper.getProp(item.borderWidth, "border-width") +
      "; border-style: " +
      prx.componentsHelper.getProp(item.borderStyle, "border-type") +
      "; border-color: " +
        ...
        [
          {
            ...
            hiddenByDefault: function (item) {
              if (
                prx.mask.isActive(item) ||
                prx.mask.editModeIsMaskSelected(item)
              )
        ...
        [
          {
            ...
            onClick: function (item) {
              ...
              var _beforeHeight = $("#" + item.id + " img").prop(
                "naturalHeight"
              );
        ...
        [
          {
            ...
            onClick: function (item) {
              if (prx.mask.isActive(item)) {
                ...
                item.mask.inner_height = parseInt(
                  item.mask.inner_height * changeRadioH
                );
...
prx.types.placeholder = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var _width =
      Math.sqrt(Math.pow(_realw, 2) + Math.pow(_realh, 2)) -
      prx.componentsHelper.getProp(item.thickness, "num-other");
    var _angle1 =
      90 -
      Math.atan(
        (_realw -
          prx.componentsHelper.getProp(item.thickness, "num-other") * 2) /
          (_realh -
            prx.componentsHelper.getProp(item.thickness, "num-other") * 2)
      ) *
        (180 / Math.PI);
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' pos box type-placeholder" style="width: ' +
      _realw +
      'px;">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    ...
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      '<div class="bg liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderColor" style="' +
      prx.gradients.getBgCssByProperty(
        item.backgroundColor,
        "color-background"
      ) +
      ...
      prx.componentsHelper.getProp(item.borderColor, "color-border") +
      "; border-width: " +
      prx.componentsHelper.getProp(item.thickness, "num-border-width") +
      'px;"></div>';
    cR +=
      '<div class="diagonal diagonal1 liveUpdate-borderColor-border-color changeProperty-borderColor" style="border-color: ' +
      prx.componentsHelper.getProp(item.borderColor, "color-border") +
      "; width: " +
      _width +
      ...
      _angle1 +
      "deg);  border-top-width: " +
      prx.componentsHelper.getProp(item.thickness, "num-border-width") +
      "px; left: " +
      prx.componentsHelper.getProp(item.thickness, "num-other") / 2 +
      'px;"></div>';
    cR +=
      '<div class="diagonal diagonal2 liveUpdate-borderColor-border-color changeProperty-borderColor" style="border-color: ' +
      prx.componentsHelper.getProp(item.borderColor, "color-border") +
      "; width: " +
      _width +
      "px; -moz-transform: rotate(-" +
    ...
    cR +=
      '<span class="shapes-text-container liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-textColor-color" style="' +
      _props +
      " " +
      prx.componentsHelper.getProp(
        item.textFont + "|" + item.textFontStyle,
  ...
  afterDisplay: function (item, containerid, symbol) {
    ...
    if (_realh <= item.thickness * 2 || _realw <= item.thickness * 2) {
      $("#" + _id + " .diagonal1, #" + _id + " .diagonal2").css(
        "display",
        "none"
      );
    } else {
  ...
  onResize: function (item, containerid, symbol) {
    ...
    var _width =
      Math.sqrt(Math.pow(_realw, 2) + Math.pow(_realh, 2)) - item.thickness;
    var _angle1 =
      90 -
      Math.atan((_realw - item.thickness * 2) / (_realh - item.thickness * 2)) *
        (180 / Math.PI);
...
prx.types.webview = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      "<iframe src=" +
      prx.componentsHelper.getProp(item.url, "url") +
      " scrolling=" +
      (prx.componentsHelper.getProp(item.scrollable, "boolean")
        ? '"yes"'
        : '"no"') +
...
prx.types.html = {
  ...
  afterDisplay: function (item, containerid, symbol) {
    ...
    div.innerHTML = DOMPurify.sanitize(item.html, {
      ADD_TAGS: ["iframe", "html", "body"],
      FORCE_BODY: true,
    });
...
prx.types.audio = {
  ...
  onDisplay: function (item, containerid, symbol) {
    let sourceType = "";
    if (item.audioFile) {
      let audioType = prx.componentsHelper.isAudioFile(item.audioFile.name)
        ? item.audioFile.name.split(".").pop()
        : "mp3";
    ...
    cR +=
      "<audio " +
      (prx.componentsHelper.getProp(item.controls, "boolean")
        ? "controls"
        : "") +
      " " +
      (prx.componentsHelper.getProp(item.preload, "boolean") && !prx.editor
        ? "preload"
        : 'preload="none"') +
      " " +
      (prx.componentsHelper.getProp(item.autoplay, "boolean") && !prx.editor
        ? "autoplay"
        : "") +
      " " +
      (prx.componentsHelper.getProp(item.loop, "boolean") ? "loop" : "") +
      ' controlsList="nodownload">';
    if (
      typeof item.audioFile !== "undefined" &&
      prx.componentsHelper.getProp(item.audioFile.fileId, "other") != ""
    )
      cR +=
        '<source src="' +
        prx.componentsHelper.getProp(item.audioFile, "asset") +
        '" type="audio/' +
        sourceType +
        '" />';
    if (prx.componentsHelper.getProp(item.audioFileMP3.fileId, "other") != "")
      cR +=
        '<source src="' +
        prx.componentsHelper.getProp(item.audioFileMP3, "asset") +
        '" type="audio/mpeg" />';
    if (prx.componentsHelper.getProp(item.audioFileOGG.fileId, "other") != "")
      cR +=
        '<source src="' +
        prx.componentsHelper.getProp(item.audioFileOGG, "asset") +
        '" type="audio/ogg" />';
    if (prx.componentsHelper.getProp(item.audioFileWAV.fileId, "other") != "")
      cR +=
        '<source src="' +
        prx.componentsHelper.getProp(item.audioFileWAV, "asset") +
        '" type="audio/x-wav" />';
    if (prx.componentsHelper.getProp(item.audioFileAAC.fileId, "other") != "")
      cR +=
        '<source src="' +
        prx.componentsHelper.getProp(item.audioFileAAC, "asset") +
        '" type="audio/x-m4a" />';
    cR += "</audio>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
...
prx.types.video = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    let sourceType = "";
    if (item.videoFile) {
      let videoType = prx.componentsHelper.isVideoFile(item.videoFile.name)
        ? item.videoFile.name.split(".").pop()
        : "mp4";
    ...
    cR +=
      ...
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-video " +
      prx.componentsHelper.getProp(item.videoType, "other") +
      '">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR += "</style>";
    ...
    switch (prx.componentsHelper.getProp(item.videoType, "other")) {
      case "html5":
        cR +=
          '<video id="' +
          _id +
          '-html5video" class="html5" width="100%" height="100%" ' +
          (prx.componentsHelper.getProp(item.controls, "boolean")
            ? "controls"
            : "") +
          " " +
          (prx.componentsHelper.getProp(item.mute, "boolean") ? "muted" : "") +
          (prx.componentsHelper.getProp(item.placeholder.fileId, "other") != ""
            ? " poster=" +
              prx.componentsHelper.getProp(item.placeholder, "asset")
            : "") +
          " " +
          (!prx.componentsHelper.getProp(item.preload, "boolean") &&
          !(
            prx.editor && prx.componentsHelper.getProp(item.autoplay, "boolean")
          )
            ? 'preload="none"'
            : "") +
          " " +
          ...
          " " +
          (prx.componentsHelper.getProp(item.loop, "boolean") ? "loop" : "") +
          ' webkit-playsinline="true" playsinline="true" controlsList="nodownload">';
        if (
          typeof item.videoFile !== "undefined" &&
          prx.componentsHelper.getProp(item.videoFile.fileId, "other") != ""
        )
          cR +=
            '<source src="' +
            prx.componentsHelper.getProp(item.videoFile, "asset") +
            '" type="video/' +
            sourceType +
            '" />';
        if (
          prx.componentsHelper.getProp(item.videoFileMP4.fileId, "other") != ""
        )
          cR +=
            '<source src="' +
            prx.componentsHelper.getProp(item.videoFileMP4, "asset") +
            '" type="video/mp4" />';
        if (
          prx.componentsHelper.getProp(item.videoFileWEBM.fileId, "other") != ""
        )
          cR +=
            '<source src="' +
            prx.componentsHelper.getProp(item.videoFileWEBM, "asset") +
            '" type="video/webm" />';
        if (
          prx.componentsHelper.getProp(item.videoFileOGG.fileId, "other") != ""
        )
          cR +=
            '<source src="' +
            prx.componentsHelper.getProp(item.videoFileOGG, "asset") +
            '" type="video/ogg" />';
        cR += "</video>";
        break;
      case "youtube":
        item.youtubeid = prx.componentsHelper.getProp(
          item.youtubeid,
          "video-url"
        );
        if (prx.editor && $.browser.chrome) {
          cR +=
            '<object width="100%" height="100%"><param name="movie" value="//www.youtube.com/v/' +
            prx.componentsHelper.getProp(item.youtubeid, "other") +
            '?version=3&amp;hl=en_GB"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="//www.youtube.com/v/' +
            prx.componentsHelper.getProp(item.youtubeid, "other") +
            '?version=3&amp;hl=en_GB" type="application/x-shockwave-flash" width="100%" height="100%" allowscriptaccess="always" allowfullscreen="true"></embed></object>';
        } else {
          cR +=
            '<iframe id="' +
            _id +
            '-youtube"   width="100%" height="100%" src="https://www.youtube.com/embed/' +
            prx.componentsHelper.getProp(item.youtubeid, "other") +
            "?enablejsapi=1&html5=1&wmode=transparent&playsinline=1" +
            (prx.componentsHelper.getProp(item.autoplay, "boolean") &&
            !prx.editor
              ? "&autoplay=1"
              : "") +
            (prx.componentsHelper.getProp(item.loop, "boolean") && !prx.editor
              ? "&loop=1&playlist=" +
                prx.componentsHelper.getProp(item.youtubeid, "other")
              : "") +
            (!prx.componentsHelper.getProp(item.controls, "boolean")
      ...
      case "vimeo":
        ...
        cR +=
          '<iframe id="' +
          _id +
          '-vimeo"  width="100%" height="100%" src="https://player.vimeo.com/video/' +
          prx.componentsHelper.getProp(item.vimeoid, "other") +
          "?api=1&amp;player_id=" +
          _id +
          "-vimeo&amp;title=0&amp;byline=0&amp;portrait=0&wmode=transparent" +
          (prx.componentsHelper.getProp(item.autoplay, "boolean") && !prx.editor
            ? "&autoplay=1"
            : "") +
          (prx.componentsHelper.getProp(item.loop, "boolean") && !prx.editor
            ? "&loop=1"
            : "") +
          (prx.componentsHelper.getProp(item.mute, "boolean")
            ? "&muted=1"
            : "") +
          '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen allow="autoplay; fullscreen"></iframe>';
        //}
          ...
          .on("touchstart", function () {
            $("#" + _id)
              ...
              .each(function (index, parent) {
                Object.keys(prx.scrollable._scrollables).forEach(function (
                  key
                ) {
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              switch (item.videoType) {
                case "youtube":
                  $(
                    "#property-videoFile, #property-videoFileMP4, #property-videoFileOGG, #property-videoFileWEBM, #property-placeholder, #property-removePlaceholder, #property-preload, #property-vimeoid"
                  ).hide();
                  $("#property-youtubeid, #property-controls").show();
                  break;
                case "vimeo":
                  $(
                    "#property-videoFile, #property-videoFileMP4, #property-videoFileOGG, #property-videoFileWEBM, #property-placeholder, #property-removePlaceholder, #property-preload, #property-youtubeid, #property-controls"
                  ).hide();
                ...
                case "html5":
                  if (prx.componentsHelper.getVideoFilesTotal(item) > 1) {
                    $(
                      "#property-videoFileMP4, #property-videoFileOGG, #property-videoFileWEBM, #property-placeholder, #property-removePlaceholder, #property-preload, #property-controls"
                    ).show();
                  } else {
        ...
        [
          {
            ...
            hiddenByDefault: function (item) {
              if (
                item.videoType == "html5" &&
                prx.componentsHelper.getVideoFilesTotal(item) <= 1
              ) {
                if (item.videoFileMP4.fileId != "") {
...
prx.types.animationtarget = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-animationtarget " +
      (typeof item.fixPositioning != "undefined" &&
      prx.componentsHelper.getProp(item.fixPositioning, "boolean")
        ? "type-animatiotarget-fixed-positioning"
        : "") +
      '">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    switch (item.ttDirection) {
      ...
      case "bottom":
        _width = "100%";
        _height =
          parseInt(_dims.height) -
          12 * prx.componentsHelper.getScale(item.lib) +
          "px";
        _margin =
          9 * prx.componentsHelper.getScale(item.lib) +
          "px 0 " +
          9 * prx.componentsHelper.getScale(item.lib) +
          "px -" +
          7 * prx.componentsHelper.getScale(item.lib) +
          "px";
        _pos =
          "width: " +
          25 * prx.componentsHelper.getScale(item.lib) +
          "px; height: " +
          (parseInt(12 * prx.componentsHelper.getScale(item.lib)) +
            parseInt(
          ...
          eval(
            (_dims.width *
              prx.componentsHelper.getProp(item.ttPosition, "num-other")) /
              100 -
              (25 *
                prx.componentsHelper.getScale(item.lib) *
                prx.componentsHelper.getProp(item.ttPosition, "num-other")) /
                100
          ) +
          "px;";
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-tooltip " +
      (item.verticalTextAlign === "center" ? "verticalAlignCenter" : "") +
      '">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR +=
      "#" +
      _id +
      " .tooltip-content-outer { padding-" +
      prx.componentsHelper.getProp(item.ttDirection, "other") +
      ": " +
      12 * prx.componentsHelper.getScale(item.lib) +
      "px; }";
    cR +=
    ...
    cR +=
      ...
      _id +
      " .tooltip { background: " +
      prx.componentsHelper.getProp(_ttBg, "color-background") +
      "; " +
      prx.componentsHelper.getProp(item.ttDirection, "other") +
      ": 0; border: " +
      prx.componentsHelper.getProp(item.borderWidth, "num-border-width") +
    ...
    cR +=
      '<div class="tooltip-content liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderRadius">';
    cR +=
      '<div class="tooltip-text liveUpdate-textColor-color changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textAlign"> <span data-editableproperty="text">' +
      prx.componentsHelper.getProp(item.text, "text-textarea") +
      "</span></div>";
    cR += "</div>";
    cR += "</div>";
    ...
    cR +=
      '<div class="tooltip liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-borderColor"></div>';
    cR += "</div>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
  ...
  onResize: function (item, containerid, symbol) {
    ...
    switch (item.ttDirection) {
      ...
      case "bottom":
        _width = "100%";
        _height =
          eval(_dims.height - 12 * prx.componentsHelper.getScale(item.lib)) +
          "px";
        $("#" + _id + " .tooltip-outer")
          .first()
          .css(
            "left",
            eval(
              (_dims.width * item.ttPosition) / 100 -
                (25 *
                  prx.componentsHelper.getScale(item.lib) *
                  item.ttPosition) /
                  100
      ...
      case "right":
        _height = "100%";
        _width =
          eval(_dims.width - 12 * prx.componentsHelper.getScale(item.lib)) +
          "px";
        $("#" + _id + " .tooltip-outer")
          .first()
          .css(
            "top",
            eval(
              (_dims.height * item.ttPosition) / 100 -
                (25 *
                  prx.componentsHelper.getScale(item.lib) *
                  item.ttPosition) /
                  100
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var _props =
      typeof prx.richtext == "undefined"
        ...
        : "";
    var text =
      '<span class="basic-button-text liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textSize"><span data-editableproperty="text">' +
      prx.componentsHelper.getProp(item.text, "text-textarea") +
      "</span></span>";
    var icon = "";
    if (
      prx.componentsHelper.getProp(item.iconpos, "icon-position") != "none" &&
      prx.componentsHelper.getProp(item.img.fileId, "other") != ""
    ) {
      icon =
        '<img class="basic-button-icon" src="' +
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-button " +
      (item.name == "basic_button_texticon" ||
      item.name == "basic_button_text" ||
      item.name == "basic_button_icon"
        ? "generic"
        : "") +
      '">';
    ...
    cR +=
      '<div class="basic-button-inner basic-button-icon-' +
      prx.componentsHelper.getProp(item.iconpos, "icon-position") +
      ' liveUpdate-backgroundColor-background liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius changeProperty-textAlign">';
        ...
        [
          {
            ...
            onChange: function (item) {
              ...
              if (item.iconpos == "notext") {
                $(
                  "#property-textSize, #property-textFont, #property-textColor, #property-textProperties, #property-textAlign, #property-textFontStyle"
                ).hide();
              } else {
                $(
                  "#property-textSize, #property-textFont, #property-textColor, #property-textProperties, #property-textAlign, #property-textFontStyle"
...
prx.types.basic_slider = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos " +
      (item.name === "ios7_slider" ? "type-ios7-slider" : "type-basic-slider") +
      '">';
    ...
    cR +=
      ...
      "px; " +
      prx.gradients.getBgCss(item.barColor) +
      "; margin-top: -" +
      prx.componentsHelper.getProp(item.barThickness, "num-other") / 2 +
      "px; border-radius: " +
      prx.componentsHelper.getProp(item.barBorderRadius, "border-radius") +
      " }";
    cR +=
      "#" +
      _id +
      " .slider-bar-filled { width: " +
      prx.componentsHelper.getProp(item.sliderPosition, "num-percentage") +
      "%; " +
      prx.gradients.getBgCss(item.fillBarColor) +
      "; border-radius: " +
      prx.componentsHelper.getProp(item.barBorderRadius, "border-radius") +
      " }";
    cR +=
      ...
      prx.componentsHelper.getProp(item.sliderColor, "color-switch") +
      "; border: " +
      prx.componentsHelper.getProp(item.sliderBorderWidth, "num-border-width") +
      "px solid " +
      prx.componentsHelper.getProp(item.borderColor, "color-border") +
      "; border-radius: " +
      prx.componentsHelper.getProp(item.sliderBorderRadius, "border-radius") +
      "; width: " +
      _dims.height +
      "px; box-sizing: border-box; margin-left: -" +
      _dims.height / 2 +
      "px; margin-right: -" +
      _dims.height / 2 +
      "px; }";
    ...
    cR +=
      '<div class="slider-bar-filled bar liveUpdate-fillBarColor-background-color"></div>';
    cR += "</div>";
    cR +=
      '<span class="slider-button liveUpdate-sliderColor-background-color liveUpdate-borderColor-border-color changeProperty-borderColor"></span>';
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
    return cR;
  },
  ...
  afterDisplay: function (item, containerid, symbol) {
    ...
    if (!prx.editor) {
      prx.draggable._draggables["#" + _id + " .slider-button"] =
        Draggable.create("#" + _id + " .slider-button", {
          type: "x",
          bounds: {
            left: -(_dims.height / 2),
            width: parseInt(_dims.width) + parseInt(_dims.height),
            top: 0,
            height: 0,
          },
          onDragStart: function () {
            ...
            $(document).on(
              ...
              function () {
                ...
                if (
                  typeof prx.variables._triggerData["#" + _id] == "undefined"
                ) {
                  prx.variables._triggerData["#" + _id] = {};
                }
      ...
      TweenLite.set("#" + _id + " .slider-button", {
        x: _dims.width * (item.sliderPosition * 0.01),
      });
      ...
      $("#" + _id + " .slider-bar")
        ...
        .on("mousedown touchstart", function (e) {
          ...
          TweenLite.to($("#" + _id + " .slider-bar-filled"), 1, {
            width: _pos,
          });
        ...
        [
          {
            ...
            type: "combo-select",
            value: function (item, name) {
              return typeof item.sliderBorderWidth == "undefined"
                ? ""
                : item.sliderBorderWidth;
            },
            values: { min: 0, max: 20, step: 1 },
            changeProperty: {
...
prx.types.vectoranimation = {
  ...
  afterDisplay: function (item, containerid, symbol, callback) {
    ...
    var _animationData = _isUploading
      ? prx.componentsHelper.getProp(item.imgSrc, "asset")
      : false;
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-vectoranimation " +
      (prx.componentsHelper.getProp(item.propagateEvents, "boolean")
        ? "pointer-events-none"
        : "") +
      (prx.componentsHelper.getProp(item.repeat, "boolean")
        ? " type-vectoranimation-repeater"
        : "") +
      '" ' +
      (prx.componentsHelper.getProp(item.overlay, "boolean")
        ? 'data-mpoverlay="1"'
    ...
    cR +=
      '<div class="vector-inner borderPos-' +
      prx.componentsHelper.getProp(item.borderPos, "other") +
      '">';
    ...
    cR +=
      '<div id="' +
      _id +
      '-vector-wrapper" class="type-vectoranimation-wrapper liveUpdate-borderColor-border-color changeProperty-borderColor changeProperty-borderRadius changeProperty-borderWidth ' +
      missingClass +
      '">';
    ...
    if (prx.editor) {
      if (!isUploading) {
        if (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") == "") {
          ...
          cR +=
            '<div id="' +
            _id +
            '-bodymovin" class="bodymovin" data-fileid="' +
            item.imgSrc.fileId +
            '" data-name="' +
            _id +
            '" data-speed = "' +
            prx.componentsHelper.getProp(item.playbackSpeed, "num-other") +
            '" data-anim-loop = "false" data-anim-autoplay="false" data-bm-path="' +
            toCheck +
        ...
        cR +=
          ...
          '"  data-speed = "' +
          prx.componentsHelper.getProp(item.playbackSpeed, "num-other") +
          '" data-anim-loop = "false" data-anim-autoplay="false" data-bm-renderer="svg"></div>';
      }
      ...
      if (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") == "") {
        cR +=
          '<img id="' +
          _id +
          '-bodymovin" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" style="width:"+tempW+"px;height:"+tempH+"px""  class="bodymovin-player" data-fileid="' +
          item.imgSrc.fileId +
          '" style="width:' +
          tempW +
          "px;height:" +
        ...
        cR +=
          '<div id="' +
          _id +
          '-bodymovin" class="bodymovin-player" data-fileid="' +
          item.imgSrc.fileId +
          '"  data-name="' +
          _id +
          '"  data-speed = "' +
    ...
    if (
      prx.editor &&
      prx.componentsHelper.getProp(item.imgSrc.fileId, "other") ==
        "5222c5ba6594f582d406726697aebb2f.json" &&
      prx.componentsHelper.getProp(item.imgSrc.assetType, "other") == "gallery"
    ) {
      cR +=
        '<div class="type-vectoranimation-hover-message">Double-click to change Lottie JSON file</div>';
      cR +=
        "<style>#" +
        _id +
        " .vector-inner { background-color: #f9f9f9; }</style>";
      cR +=
        "<style>#" +
        _id +
        " .type-vectoranimation-wrapper { border: " +
        1 * prx.componentsHelper.getScale(item.lib) +
        "px solid #eee; box-sizing: border-box; }</style>";
    } else {
      cR += "<style>";
      cR +=
        "#" +
        ...
        ", #" +
        _id +
        " .type-vectoranimation-wrapper { border-radius: " +
        prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
        ";}";
      cR +=
        "#" +
...
prx.types.basic_tabbar = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var activebg = prx.componentsHelper.getProp(
    ...
    var cR =
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-tabbar type-basic-tabbar-icon-" +
      prx.componentsHelper.getProp(item.iconpos, "other") +
      '" ' +
      (prx.componentsHelper.getProp(item.overlay, "boolean")
        ? 'data-mpoverlay="1"'
        : "") +
      ">";
    var _tabWidth = Math.floor(
      (_dims.width -
        prx.componentsHelper.getProp(item.borderWidth, "num-border-width") *
          (item.tabs.length - 1)) /
        item.tabs.length
    ...
    cR +=
      ...
      _id +
      " input:checked + label { " +
      prx.gradients.getBgCssByProperty(activebg, "color-background") +
      "; }";
    cR +=
      "#" +
      _id +
      " input:checked + label .caption { color: " +
      prx.componentsHelper.getProp(item.activeTextColor, "color-border") +
      "; }";
    if (item.maskEnabled) {
      cR +=
        "#" +
    ...
    cR +=
      '<ul class="liveUpdate-backgroundColor-background-color changeProperty-backgroundColor">';
    $.each(item.tabs, function (i, elm) {
      ...
      cR +=
        ...
        "-tabs-" +
        i +
        '" class="dynamic-property liveUpdate-borderColor-border-color changeProperty-borderColor" data-dynamic-property-index="' +
        i +
        '" ' +
      ...
      cR +=
        ...
        '" ' +
        (prx.componentsHelper.getProp(item.activeTab, "num-other") == i
          ? 'class="liveUpdate-activeBackgroundColor-background-color"'
          : "") +
        " >";
  ...
  onResize: function (item, containerid, symbol) {
    ...
    var _tabWidth = Math.floor(
      (_dims.width -
        item.borderWidth *
          (item.tabs.length - 1 * prx.componentsHelper.getScale(item.lib))) /
        item.tabs.length
    );
    switch (item.iconpos) {
      case "top":
      ...
      $("#" + _id + " [data-linked-screen]").each(function () {
        ...
        if (prx.stc.screens.getIndexFromId(screenId) != -1) {
          ...
          prx.actions.disableFlashActionOnItemTap(
            action.bindTo,
            ".flashactiontap-afterdisplay"
          ); // default one called from actions.build will be disabled in parseaction soon afterwards
        }
      });
    }
  },
        ...
        [
          {
            ...
            onChange: function (item) {
              if (item.iconpos == "") {
                $(
                  "[id=property-icon], [id=property-activeicon], #property-iconSize, #property-maskEnabled, #property-maskInactive, #property-maskActive"
                ).hide();
              } else {
                $(
                  "[id=property-icon], [id=property-activeicon], #property-iconSize, #property-maskEnabled, #property-maskInactive, #property-maskActive"
              ...
              if (item.iconpos == "notext") {
                $(
                  "[id=property-text], #property-textSize, #property-textFont, #property-textFontStyle, #property-textColor, #property-textProperties, #property-activeTextColor"
                ).hide();
              } else {
                $(
                  "[id=property-text], #property-textSize, #property-textFont, #property-textFontStyle, #property-textColor, #property-textProperties, #property-activeTextColor"
          ...
          },
          {
            caption: function (item, name) {
              if (
                item.name === "basic_tabbar_icon" ||
                item.name === "basic_tabbar_texticon"
              )
                return "Size";
              return false;
            },
  ...
  dynamicProperties: {
    ...
    blankItem: {
      ...
      icon: {
        ...
        targetSrc: "generated/a764f2746aa43431594a25b3e9d5dc34_6c7075.svg",
        color: "6c7075",
      },
      activeicon: {
        fileId: "a764f2746aa43431594a25b3e9d5dc34.svg",
        ...
        bucketsource: "static",
        url: "f1352971179296/94a90bf9a645dba63ad7a41d18f82ea7.svg",
        targetSrc: "generated/a764f2746aa43431594a25b3e9d5dc34_ffffff.svg",
        color: "ffffff",
      },
      actions: [],
    },
...
prx.types.generic_onoffswitch = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var cR =
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-generic-onoffswitch">';
    ...
    cR +=
      "#" +
      _id +
      " .onoffswitch-inner div { line-height: " +
      (item.height - 4 * prx.componentsHelper.getScale(item.lib)) +
      "px; }";
    cR +=
      "#" +
      _id +
      " .onoffswitch-inner .active { background-color: " +
      prx.componentsHelper.getProp(item.activeLabelColor, "color-background") +
      "; color: " +
      prx.componentsHelper.getProp(item.activeLabelTextColor, "color-text") +
      "; }";
    cR +=
      "#" +
      _id +
      " .onoffswitch-inner .inactive { background-color: " +
      prx.componentsHelper.getProp(
        item.inactiveLabelColor,
        "color-background"
      ) +
      "; color: " +
      prx.componentsHelper.getProp(item.inactiveLabelTextColor, "color-text") +
      "; }";
    cR +=
      "#" +
      _id +
      " .onoffswitch-switch { background-color: " +
      prx.componentsHelper.getProp(item.switchColor, "color-background") +
      "; width: " +
      prx.componentsHelper.getProp(item.switchSize, "num-other") +
      "px; border-radius: " +
      prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
      "; margin: " +
      (item.height -
      ...
      "px; right: " +
      (item.width -
        (Number(item.switchSize) +
          4 +
          (item.height - Number(item.switchSize)))) +
      "px; }";
    cR += "</style>";
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      ...
      ' id="' +
      _id +
      '-onoffswitch" data-role="none" >';
    cR += '<label for="' + _id + '-onoffswitch">';
    cR += '<div class="onoffswitch-inner">';
    cR +=
      '<div class="active">' +
      prx.componentsHelper.getProp(item.activeLabelText, "other") +
      "</div>";
    cR +=
      '<div class="inactive">' +
      prx.componentsHelper.getProp(item.inactiveLabelText, "other") +
      "</div>";
    cR += "</div>";
...
prx.types.datetime = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      _id +
      " sup {font-size: " +
      prx.componentsHelper.getProp(item.textSize, "num-text-size") * 0.75 +
      "px;}";
    cR += "</style>";
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      '<div id="background" class="liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-borderColor-border-color changeProperty-borderColor">';
    cR +=
      '<div id="datetime" class="liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont  changeProperty-textSize"></div>';
    cR += "</div>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
    ...
    var displayTime = function () {
      switch (item.timeFormat) {
        ...
        case "12b":
          ...
          return (
            hour + ":" + ("0" + datetime.getMinutes()).slice(-2) + " " + ampm
          );
          break;
        case "24":
          return (
  ...
  propertyGroups: [
    ...
    },
    {
      ...
      properties: [
        ...
        [prx.commonproperties.textProperties, prx.commonproperties.textColor()],
        [prx.commonproperties.textAlign],
      ],
    },
    {
        ...
        [
          {
            caption: {
              ...
              class: "component-datetime-label",
            },
            name: "dateGeneralFormat",
            proptype: "datetime-general-format",
            type: "select",
            value: function (item, name) {
              return typeof item.dateGeneralFormat == "undefined"
                ? ""
                : item.dateGeneralFormat;
            },
        ...
        [
          {
            ...
            type: "select",
            value: function (item, name) {
              return typeof item.dateFormat == "undefined"
                ? ""
                : item.dateFormat;
            },
        ...
        [
          {
            ...
            type: "select",
            value: function (item, name) {
              return typeof item.dateSeparator == "undefined"
                ? ""
                : item.dateSeparator;
            },
        ...
        [
          {
            ...
            type: "select",
            value: function (item, name) {
              return typeof item.dayNameFormat == "undefined"
                ? ""
                : item.dayNameFormat;
            },
          ...
          },
          {
            ...
            type: "select",
            value: function (item, name) {
              return typeof item.monthFormat == "undefined"
                ? ""
                : item.monthFormat;
            },
          ...
          },
          {
            ...
            type: "select",
            value: function (item, name) {
              return typeof item.yearFormat == "undefined"
                ? ""
                : item.yearFormat;
            },
        ...
        [
          {
            ...
            type: "select",
            value: function (item, name) {
              return typeof item.timeFormat == "undefined"
                ? ""
                : item.timeFormat;
            },
...
prx.components.vectoranimation = {
  ...
  imgSrc: {
    fileId: "5222c5ba6594f582d406726697aebb2f.json",
    assetType: "gallery",
    bucketsource: "static",
    name: " balloon_animation.json",
    url: "f1353077251107/5222c5ba6594f582d406726697aebb2f.json",
    vectorAnimationType: "bodymovin",
  },
  repeat: false,
  width: 200 * prx.componentsHelper.getScale(_library),
  height: 200 * prx.componentsHelper.getScale(_library),
...
prx.components.icon = {
  ...
  imgSrc: {
    fileId: "0fe09f6dd3fe341363f4d011b280b36c.svg",
    name: "light-on.svg",
    assetType: "icon",
    bucketsource: "static",
    url: "f1352971179296/0fe09f6dd3fe341363f4d011b280b36c.svg",
  },
  repeat: false,
  width: 100 * prx.componentsHelper.getScale(_library),
  height: 100 * prx.componentsHelper.getScale(_library),
  ...
  tabs: [
    {
      ...
      icon: {
        ...
        targetSrc: "generated/e6a1ba573190139ceda51280e9fdad9c_333333.svg",
        color: "383838",
      },
      activeicon: {
        fileId: "e4e7dbcddba77b96954aa3602719162c.svg",
    ...
    },
    {
      ...
      icon: {
        ...
        targetSrc: "generated/1b58b288e91e6a4cb64d90433880003d_333333.svg",
        color: "383838",
      },
      activeicon: {
        fileId: "e55334acc02f524531f172be5348bfd2.svg",
