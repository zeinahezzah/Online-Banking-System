...
prx.types.basic_buttongroup = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      " box pos type-basic-buttongroup " +
      (item.isVertical ? "vertical" : "horizontal") +
      " iconpos-" +
      item.iconpos +
      " textAlign-" +
      item.textAlign +
    ...
    cR +=
      "#" +
      _id +
      " .basic-buttongroup-button input:checked + label { " +
      prx.gradients.getBgCssByProperty(
    ...
    if (item.isVertical) {
      cR +=
        "#" +
        _id +
        " .basic-buttongroup-button { width: 100%; border-top: " +
        prx.componentsHelper.getProp(item.borderWidth, "num-border-width") +
        "px solid " +
        prx.componentsHelper.getProp(item.borderColor, "color-border") +
        "; }";
      cR +=
        "#" + _id + " .basic-buttongroup-button:first-child {border-top: 0px}";
      cR +=
        "#" +
        _id +
        " .basic-buttongroup-button:first-child label { border-top-left-radius: " +
      ...
      cR +=
        "#" +
        _id +
        " .basic-buttongroup-button:last-child label { border-bottom-left-radius: " +
        prx.componentsHelper.getProp(
          parseInt(
            prx.componentsHelper.getProp(item.borderRadius, "border-radius")
          ) -
      ...
      cR +=
        ...
        _id +
        " .icon-wrapper { " +
        (item.iconpos == "right" ? "order: 2; " : "") +
        "width: " +
        (prx.componentsHelper.getProp(_dims.height, "num-other") /
          item.buttons.length /
          100) *
          item.iconSize *
          20 *
      ...
      cR +=
        "#" +
        _id +
        " .basic-buttongroup-button { height: 100%; border-left: " +
        prx.componentsHelper.getProp(item.borderWidth, "num-border-width") +
        "px solid " +
        prx.componentsHelper.getProp(item.borderColor, "color-border") +
        "; }";
      ...
      cR +=
        "#" +
        _id +
        " .basic-buttongroup-button:last-child label { border-top-right-radius: " +
        prx.componentsHelper.getProp(
          parseInt(
            prx.componentsHelper.getProp(item.borderRadius, "border-radius")
          ) -
      ...
      cR +=
        ...
        (item.iconpos == "right" ? "order: 2; " : "") +
        "width: " +
        (prx.componentsHelper.getProp(_dims.height, "num-other") / 100) *
          item.iconSize *
          20 *
          1.1 +
        "px; }";
    ...
    if (item.iconpos !== "top") {
      cR +=
        ...
        _id +
        " .icon-wrapper { height: " +
        prx.componentsHelper.getProp(item.iconSize, "num-other") * 20 +
        "%; }";
    }
    if (item.maskEnabled) {
      cR +=
        ...
        prx.componentsHelper.getProp(item.maskInactive, "color-background") +
      ...
      if (item.iconpos !== "top") {
        cR +=
          "#" +
          _id +
          " .icon { -webkit-mask-size: auto 100%; mask-size: auto 100%;}";
      } else {
        cR +=
          "#" +
          _id +
          " .icon {-webkit-mask-size: auto " +
          item.iconSize * 20 +
          "%; mask-size: auto " +
          item.iconSize * 20 +
          "%;}";
      ...
      cR +=
        "#" +
        _id +
        " input:checked + label .icon { background-color: " +
        prx.componentsHelper.getProp(item.maskActive, "color-background") +
        " }";
    }
    cR += "</style>";
    ...
    $.each(item.buttons, function (i, elm) {
      cR +=
        ...
        "-buttons-" +
        i +
        '" class="basic-buttongroup-button dynamic-property liveUpdate-borderColor-border-color changeProperty-borderWidth changeProperty-borderColor' +
        (i == 0 || i == item.buttons.length - 1
          ? " changeProperty-borderRadius"
          : "") +
        '" data-dynamic-property-index="' +
        i +
        '">';
      if (
        prx.componentsHelper.getProp(item.iconpos, "other") != "noicon" &&
        prx.componentsHelper.getProp(item.iconpos, "other") != "none"
      ) {
        cR += "<style>";
        ...
        if (prx.componentsHelper.getProp(item.maskEnabled, "boolean")) {
          var assetPathWithMaskEnabled =
            prx.componentsHelper.maskImageFixForSafari11(elm.icon);
          cR +=
            "#" +
            _id +
            " label[for=" +
            ...
            "-radio-" +
            i +
            '-overlay] .icon { -webkit-mask-image: url("' +
          ...
          if (item.iconpos !== "top") {
            cR +=
              ...
              "-radio-" +
              i +
              "-overlay] .icon { background-size: auto 100%; }";
          } else {
            cR +=
              "#" +
              _id +
              ...
              "-radio-" +
              i +
              "-overlay] .icon { background-size: auto " +
              item.iconSize * 20 +
              "%; }";
          }
          cR +=
            ...
            "-radio-" +
            i +
            "-overlay] .icon { background-image: url(" +
            prx.componentsHelper.getProp(elm.icon, "asset") +
            "); }";
          if (
            !prx.componentsHelper.getProp(item.maskEnabled, "boolean") &&
            prx.componentsHelper.getProp(elm.activeicon.fileId, "other") !=
              "" &&
      ...
      cR +=
        ...
        i +
        '" ' +
        (prx.componentsHelper.getProp(item.selected, "num-other") == i
          ? "checked"
          : "") +
        ' data-role="none" ' +
        (prx.componentsHelper.getProp(item.active, "num-other") == i
          ? 'class="liveUpdate-activeBackgroundColor-background-color liveUpdate-activeTextColor-color changeProperty-activeBackgroundColor"'
          : "") +
        " " +
      ...
      cR +=
        ...
        '" ' +
        (prx.componentsHelper.getProp(item.selected, "num-other") == i
          ? 'class="changeProperty-activeBackgroundColor liveUpdate-activeBackgroundColor-background-color liveUpdate-activeTextColor-color"'
          : "") +
        " >";
      if (
        prx.componentsHelper.getProp(item.iconpos, "other") != "noicon" &&
      ...
      if (item.iconpos != "notext") {
        cR +=
          '<div class="caption ' +
          (item.activeTab == i
            ? "liveUpdate-activeTextColor-color"
            : "liveUpdate-textColor-color") +
          ...
          },
          {
            ...
            changeProperty: {
              ...
              changeFunction: function (item, containerid) {
                var _id = !containerid ? item.id : containerid + "-" + item.id;
                $("#" + _id).append(
                  `<style>#${_id} .basic-buttongroup-button input:checked + label { ${prx.gradients.getBgCssByProperty(
                    item.activeBackgroundColor,
                    "color-background"
                  )}; }</style>`
                );
          ...
          },
          {
            ...
            changeProperty: {
              ...
              changeFunction: function (item, containerid) {
                var _id = !containerid ? item.id : containerid + "-" + item.id;
                $("#" + _id).append(
                  `<style>#${_id} .basic-buttongroup-button input:checked + label { color: ${prx.componentsHelper.getProp(
        ...
        [
          {
            ...
            values: function (item, name) {
              ...
              if (
                item.name !== "basic_buttongroup_horizontal_texticon_right" &&
                item.name !== "basic_buttongroup_horizontal_texticon_top" &&
                item.name !== "basic_buttongroup_vertical_texticon"
              ) {
              ...
              if (
                ...
                possibleValues.push({
                  value: "notext",
                  displayValue: "Icon only (no text)",
                });
              }
            ...
            onChange: function (item) {
              if (item.iconpos == "none") {
                $(
                  "#property-iconSize, #property-maskEnabled, #property-maskInactive, #property-maskActive"
                ).hide();
              } else {
                $(
                  "#property-iconSize, #property-maskEnabled, #property-maskInactive, #property-maskActive"
              ...
              if (item.iconpos == "notext") {
                $(
                  "#property-textSize, #property-textFont, #property-textFontStyle, #property-textColor, #property-textProperties, #property-textAlign, #property-activeTextColor"
                ).hide();
              } else {
                $(
                  "#property-textSize, #property-textFont, #property-textFontStyle, #property-textColor, #property-textProperties, #property-textAlign, #property-activeTextColor"
          ...
          },
          {
            caption: function (item, name) {
              if (
                item.name === "basic_buttongroup_horizontal_icon" ||
                item.name === "basic_buttongroup_vertical_icon"
              )
                return "Size";
  ...
  dynamicProperties: {
    ...
    blankItem: {
      ...
      icon: {
        ...
        assetType: "icon",
        bucketsource: "static",
        url: "f1352971179296/caeebe7f3a62939528c6a4ed009de42c.svg",
        targetSrc: "generated/987371e0c84e1e3877c0b8f6aea57272_6c7075.svg",
        color: "6c7075",
      },
      activeicon: {
        fileId: "987371e0c84e1e3877c0b8f6aea57272.svg",
        ...
        bucketsource: "static",
        url: "f1352971179296/caeebe7f3a62939528c6a4ed009de42c.svg",
        targetSrc: "generated/987371e0c84e1e3877c0b8f6aea57272_ffffff.svg",
        color: "ffffff",
      },
      actions: [],
    },
              ...
              changeProperty: {
                ...
                changeFunction(item, containerid, duration, easing, index) {
                  ...
                  if (
                    ...
                    prx.componentsHelper.addStyleForChangeFunction(
                      id,
                      id + "-maskicon-background-size-" + index,
                      cssSelector,
                      "background-size",
                      "auto 60%",
                      "other"
...
prx.types.basic_buttongroup_horizontal_text = prx.componentsHelper.cloneobject(
  prx.types.basic_buttongroup
);
prx.types.basic_buttongroup_horizontal_text.name =
  "basic_buttongroup_horizontal_text";
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_horizontal_text.propertyGroups,
  ["iconpos", "iconSize", "maskEnabled", "maskInactive", "maskActive"]
);
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_horizontal_text.dynamicProperties.propertyGroups,
  ["icon", "activeicon"]
);

//TYPE: BUTTON GROUP - ICONS ONLY HORIZONTAL
prx.types.basic_buttongroup_horizontal_icon = prx.componentsHelper.cloneobject(
  prx.types.basic_buttongroup
);
prx.types.basic_buttongroup_horizontal_icon.name =
  "basic_buttongroup_horizontal_icon";
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_horizontal_icon.propertyGroups,
  [
    "textFont",
    "textSize",
    "textFontStyle",
...
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_horizontal_icon.dynamicProperties
    .editableProperties,
  ["text"]
);

//TYPE: BUTTON GROUP - TEXT VERTICAL
prx.types.basic_buttongroup_vertical_text = prx.componentsHelper.cloneobject(
  prx.types.basic_buttongroup
);
prx.types.basic_buttongroup_vertical_text.name =
  "basic_buttongroup_vertical_text";
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_vertical_text.propertyGroups,
  ["iconpos", "iconSize", "maskEnabled", "maskInactive", "maskActive"]
);
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_vertical_text.dynamicProperties.propertyGroups,
  ["icon", "activeicon"]
);

//TYPE: BUTTON GROUP - TEXT ICON VERTICAL
prx.types.basic_buttongroup_vertical_texticon =
  prx.componentsHelper.cloneobject(prx.types.basic_buttongroup);
prx.types.basic_buttongroup_vertical_texticon.name =
  "basic_buttongroup_vertical_text";

//TYPE: BUTTON GROUP - ICONS ONLY VERTICAL
prx.types.basic_buttongroup_vertical_icon = prx.componentsHelper.cloneobject(
  prx.types.basic_buttongroup
);
prx.types.basic_buttongroup_vertical_icon.name =
  "basic_buttongroup_vertical_icon";
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_vertical_icon.propertyGroups,
  [
    "textFont",
    "textSize",
    "textFontStyle",
...
prx.componentsHelper.removeProperties(
  prx.types.basic_buttongroup_vertical_icon.dynamicProperties
    .editableProperties,
  ["text"]
);
...
prx.types.basic_checkbox_list = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-checkboxlist " +
      (item.isVertical ? "vertical" : "horizontal") +
      " iconpos-" +
      item.iconpos +
      " textAlign-" +
    ...
    if (item.isVertical) {
      ...
      cR +=
        "#" +
        _id +
        " .basic-checkboxlist-button { width: 100%; border-top: " +
        prx.componentsHelper.getProp(item.borderWidth, "num-border-width") +
        "px solid " +
        prx.componentsHelper.getProp(item.borderColor, "color-border") +
        "; }";
      cR +=
        "#" + _id + " .basic-checkboxlist-button:first-child {border-top: 0px}";
      cR +=
        "#" +
        _id +
        " .basic-checkboxlist-button input:checked + label { " +
        prx.gradients.getBgCssByProperty(
          item.activeBackgroundColor,
          "color-background"
        ) +
      ...
      cR +=
        "#" +
        _id +
        " .basic-checkboxlist-button:first-child label { border-top-left-radius: " +
        prx.componentsHelper.getProp(
          parseInt(
            prx.componentsHelper.getProp(item.borderRadius, "border-radius")
          ) -
      ...
      cR +=
        "#" +
        _id +
        " .basic-checkboxlist-button:last-child label { border-bottom-left-radius: " +
        prx.componentsHelper.getProp(
          parseInt(
            prx.componentsHelper.getProp(item.borderRadius, "border-radius")
          ) -
      ...
      cR +=
        ...
        _id +
        " .icon { height: " +
        (_dims.height / item.listitems.length || 1) *
          prx.componentsHelper.getProp(item.iconSize, "num-other") *
          0.2 +
        "px;}";
    } else {
      cR +=
      ...
      cR +=
        "#" +
        _id +
        " .basic-checkboxlist-button { height: 100%; border-left: " +
        prx.componentsHelper.getProp(item.borderWidth, "num-border-width") +
        "px solid " +
        prx.componentsHelper.getProp(item.borderColor, "color-border") +
        "; }";
      ...
      cR +=
        "#" +
        _id +
        " .basic-checkboxlist-button:last-child label { border-top-right-radius: " +
        prx.componentsHelper.getProp(
          parseInt(
            prx.componentsHelper.getProp(item.borderRadius, "border-radius")
          ) -
    ...
    cR +=
      '<div class="basic-checkboxlist-inner liveUpdate-backgroundColor-background-color liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderRadius changeProperty-borderWidth changeProperty-textColor changeProperty-textSize changeProperty-textFont">';
    $.each(item.listitems, function (i, elm) {
      cR +=
        ...
        "-buttons-" +
        i +
        '" class="basic-checkboxlist-button dynamic-property liveUpdate-borderColor-border-color changeProperty-borderWidth changeProperty-borderColor' +
        (i == 0 || i == item.listitems.length - 1
          ? " changeProperty-borderRadius"
          : "") +
        '" data-dynamic-property-index="' +
        i +
      ...
      cR +=
        ...
        '" ' +
        (prx.componentsHelper.getProp(item.selected, "num-other") == i ||
        (Array.isArray(item.selected) && item.selected.includes(i.toString()))
          ? "checked"
          : "") +
        ' data-role="none" ' +
        (prx.componentsHelper.getProp(item.active, "num-other") == i
      ...
      if (
        ...
        cR +=
          '<img class="icon inactiveIcon" src="' +
          prx.componentsHelper.getProp(item.inactiveicon, "asset") +
          '">';
        cR +=
          '<img class="icon activeIcon" src="' +
          prx.componentsHelper.getProp(item.activeicon, "asset") +
          '">';
      }
      cR +=
        '<div class="caption ' +
          ...
          prx.commonproperties.borderColor,
          {
            ...
            changeProperty: {
              ...
              changeFunction: function (
                ...
                var _id = !containerid ? item.id : containerid + "-" + item.id;
                $("#" + _id + " .basic-checkboxlist-inner").css(
                  "border-radius",
                  item.borderRadius + "px"
                );
                if (item.isVertical) {
                  $(
                    "#" + _id + " .basic-checkboxlist-button:first-child label"
                  ).css({
                    "border-top-left-radius": item.borderRadius + "px",
                    "border-top-right-radius": item.borderRadius + "px",
                  });
                  $(
                    "#" + _id + " .basic-checkboxlist-button:last-child label"
                  ).css({
                    "border-bottom-left-radius": item.borderRadius + "px",
                    "border-bottom-right-radius": item.borderRadius + "px",
                  });
                } else {
                  $(
                    "#" + _id + " .basic-checkboxlist-button:first-child label"
        ...
        [
          {
            ...
            onChange: function (item) {
              if (item.iconpos == "none") {
                $(
                  "#property-iconSize, #property-inactiveicon, #property-activeicon"
                ).hide();
              } else {
                $(
                  "#property-iconSize, #property-inactiveicon, #property-activeicon"
...
prx.types.basic_checkbox_list_horizontal = prx.componentsHelper.cloneobject(
  prx.types.basic_checkbox_list
);
prx.types.basic_checkbox_list_horizontal.name =
  "basic_checkbox_list_horizontal";

//TYPE: CHECKBOX LIST VERTICAL
prx.types.basic_checkbox_list_vertical = prx.componentsHelper.cloneobject(
  prx.types.basic_checkbox_list
);
prx.types.basic_checkbox_list_vertical.name = "basic_checkbox_list_vertical";

//TYPE: BASIC BUTTON text ICON
prx.types.basic_button_texticon = prx.componentsHelper.cloneobject(
  prx.types.basic_button_bg
);
prx.types.basic_button_texticon.name = "basic_button_texticon";
prx.types.basic_button_texticon.propertyGroups =
...
prx.types.basic_button_icon = prx.componentsHelper.cloneobject(
  prx.types.basic_button_bg
);
prx.types.basic_button_icon.name = "basic_button_icon";
prx.componentsHelper.removeProperties(
  prx.types.basic_button_icon.propertyGroups,
  [
    "iconpos",
    "textFont",
    "textFontStyle",
...
prx.componentsHelper.removeProperties(
  prx.types.basic_button_icon.editableProperties,
  ["text"]
);

//TYPE: BASIC BUTTON TEXT
prx.types.basic_button_text = prx.componentsHelper.cloneobject(
  prx.types.basic_button_bg
);
prx.types.basic_button_text.name = "basic_button_text";
prx.componentsHelper.removeProperties(
  prx.types.basic_button_text.propertyGroups,
  ["iconpos", "iconSize", "img"]
);

//TYPE: BASIC TABBAR TEXT
prx.types.basic_tabbar_text = prx.componentsHelper.cloneobject(
  prx.types.basic_tabbar
);
prx.types.basic_tabbar_text.name = "basic_tabbar_text";
prx.componentsHelper.removeProperties(
  prx.types.basic_tabbar_text.propertyGroups,
  ["iconpos", "iconSize", "maskEnabled", "maskInactive", "maskActive"]
);
prx.componentsHelper.removeProperties(
  prx.types.basic_tabbar_text.dynamicProperties.propertyGroups,
  ["icon", "activeicon"]
);

//TYPE: BASIC TABBAR ICON
prx.types.basic_tabbar_icon = prx.componentsHelper.cloneobject(
  prx.types.basic_tabbar
);
prx.types.basic_tabbar_icon.name = "basic_tabbar_icon";
prx.componentsHelper.removeProperties(
  prx.types.basic_tabbar_icon.propertyGroups,
  [
    "textFont",
    "textSize",
    "textColor",
...
prx.componentsHelper.removeProperties(
  prx.types.basic_tabbar_icon.dynamicProperties.editableProperties,
  ["text"]
);

//TYPE: BASIC TABBAR TEXT & ICON
prx.types.basic_tabbar_texticon = prx.componentsHelper.cloneobject(
  prx.types.basic_tabbar
);
prx.types.basic_tabbar_texticon.name = "basic_tabbar_texticon";
prx.componentsHelper.removeProperties(
  prx.types.basic_tabbar_texticon.propertyGroups,
  ["iconpos"]
);
...
prx.types.basic_switch = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      "#" +
      _id +
      " label .switch-background { width: 100%; height: 100%; border-radius: " +
      prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
      "; border: " +
      prx.componentsHelper.getProp(item.borderWidth, "num-border-width") +
      "px solid " +
      prx.componentsHelper.getProp(item.borderColor, "color-border") +
      "; background: " +
      prx.componentsHelper.getProp(item.inactiveBarColor, "color-background") +
      "; }";
    cR +=
      "#" +
      _id +
      " input:checked + label .switch-background { background: " +
      prx.componentsHelper.getProp(item.activeBarColor, "color-background") +
      "; }";
    cR +=
      "#" +
      _id +
      " .switch { left: " +
      (_dims.height - item.switchSize) / 2 +
      "px; width: " +
      item.switchSize +
      "px; height: " +
      item.switchSize +
    ...
    cR +=
      "#" +
      _id +
      " input:checked + label .switch-background .switch { left: " +
      (_dims.width -
        item.switchSize -
        item.borderWidth * 2 -
        (_dims.height - item.switchSize) / 2) +
    ...
    cR +=
      ...
      _type +
      '" ' +
      (prx.componentsHelper.getProp(item.active, "boolean") ? "checked" : "") +
      ' id="' +
      _id +
    ...
    var labelClasses, switchClasses;

    if (prx.componentsHelper.getProp(item.active, "boolean")) {
      labelClasses =
        " liveUpdate-activeBarColor-background changeProperty-activeBarColor";
      switchClasses =
        "liveUpdate-activeSwitchColor-background changeProperty-activeSwitchColor";
    } else {
      labelClasses =
        " liveUpdate-inactiveBarColor-background changeProperty-inactiveBarColor";
      switchClasses =
        "liveUpdate-inactiveSwitchColor-background changeProperty-inactiveSwitchColor";
    }

    cR +=
      '<label for="' +
      _id +
      '-flipswitch"><div class="switch-background liveUpdate-borderColor-border-color changeProperty-borderWidth changeProperty-borderColor changeProperty-borderRadius ' +
      labelClasses +
      '" data-clickable="true">'; // data-clickable for greensock draggable - if draggable or in draggable container clicking on the flipswitch wont change state

    cR +=
      '<div class="switch liveUpdate-borderColor-border-color changeProperty-borderWidth changeProperty-borderColor changeProperty-borderRadius ' +
      switchClasses +
      '"></div>';
    cR += "</div>";
    cR += "</label>";
  ...
  onResize: function (item, containerid, symbol) {
    ...
    if ($("#" + _id + "-flipswitch").is(":checked")) {
      $("#" + _id + " label .switch-background .switch").css(
        "left",
        _dims.width -
          item.switchSize -
          item.borderWidth * 2 -
        ...
        function (e, updateStatus) {
          if (
            typeof prx.variables._triggerData[
              "#" + _id + "-flipswitch:checked"
            ] == "undefined"
          ) {
            prx.variables._triggerData["#" + _id + "-flipswitch:checked"] = {};
          }
          prx.variables._triggerData["#" + _id + "-flipswitch:checked"][
            "checkboxchange"
          ...
          prx.variables._triggerData["#" + _id + "-flipswitch:not(:checked)"][
            "checkboxchange"
          ] = { state: $(this).is(":checked") };
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                let cssSelector =
                  ...
                  "#" +
                  id +
                  "-flipswitch + label .switch-background ";
        ...
        [
          {
            ...
            type: "combo-select",
            value: function (item, name) {
              return typeof item.borderWidth == "undefined"
                ? ""
                : item.borderWidth;
            },
            values: { min: 0, max: 20, step: 1 },
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                let cssSelector =
                  ...
                  "#" +
                  id +
                  "-flipswitch + label .switch ";

                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-inactiveSwitchColor",
                  cssSelector,
                  "background",
                  item.inactiveSwitchColor,
                  "color-background"
          ...
          },
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-activeSwitchColor",
                  cssSelector,
                  "background",
                  item.activeSwitchColor,
                  "color-background"
                );
              },
            },
...
prx.types.basic_switch2 = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      "#" +
      _id +
      " label .switch-background { width: 100%; height: " +
      item.barSize +
      "px; border-radius: " +
      prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
      "; border: " +
  ...
  onResize: function (item, containerid, symbol) {
    ...
    var _dims = prx.componentsHelper.getRealDims(item, symbol);
    $("#" + _id + " .switch")
      .css("width", _dims.height)
      .css("height", _dims.height);
    if ($("#" + _id + "-flipswitch").is(":checked")) {
      $("#" + _id + " label .switch-background .switch").css(
        "left",
        _dims.width -
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var _props =
      typeof prx.richtext == "undefined"
        ...
        : "";
    var text =
      '<div class="basic-checkbox-text liveUpdate-textColor-color "><span data-editableproperty="text" class="changeProperty-textColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textSize changeProperty-textProperties">' +
    ...
    cR +=
      "#" +
      _id +
      " label .basic-checkbox-text { width: calc(100% - " +
      parseInt(item.checkboxSize, 10) +
      "px - " +
      12 * prx.componentsHelper.getScale(item.lib) +
      "px); margin-left: " +
      (parseInt(item.checkboxSize, 10) +
        12 * prx.componentsHelper.getScale(item.lib)) +
      "px;  " +
      ...
      prx.componentsHelper.getProp(item.textFontStyle, "font-style") +
      " color: " +
      prx.componentsHelper.getProp(item.textColor, "color-text") +
      "; font-size: " +
      prx.componentsHelper.getProp(item.textSize, "num-text-size") +
    ...
    cR +=
      "#" +
      _id +
      " label .basic-checkbox-inner { top: " +
      (parseInt(item.textSize, 10) - parseInt(item.checkboxSize, 10)) / 2 +
      "px; width: " +
      item.checkboxSize +
      "px; height: " +
      item.checkboxSize +
    ...
    cR +=
      "#" +
      _id +
      " input:checked + label .basic-checkbox-inner { background: " +
      prx.componentsHelper.getProp(
        item.activeBackgroundColor,
        "color-background"
      ) +
    ...
    cR +=
      '<label for="' +
      _id +
      '-checkbox" data-clickable="true"><div class="basic-checkbox-inner ' +
      (prx.componentsHelper.getProp(item.active, "boolean")
        ? "liveUpdate-activeBackgroundColor-background-color changeProperty-activeBackgroundColor"
        : "liveUpdate-backgroundColor-background-color changeProperty-backgroundColor") +
      ' liveUpdate-borderColor-border-color changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius">';
    cR +=
      '<img class="basic-checkbox-icon" src="' +
      prx.componentsHelper.getProp(item.img, "asset") +
      '">';
    cR += "</div>";
    cR += text;
    cR += "</label>";
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                let cssSelector =
                  ...
                  "#" +
                  id +
                  "-checkbox + label .basic-checkbox-inner  ";
...
prx.types.basic_searchbar = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-searchbar type-basic-searchbar-text textAlign-" +
    ...
    cR +=
      "#" +
      _id +
      " .basic-searchbar-faux-input { color: " +
      prx.componentsHelper.getProp(item.textColor, "color-text") +
      "; font-size: " +
      prx.componentsHelper.getProp(item.textSize, "num-text-size") +
      "px;  " +
    ...
    cR +=
      "#" +
      _id +
      " .basic-searchbar-faux-input-overlay .placeholder-input, #" +
      _id +
      " .basic-searchbar-input-overlay .placeholder-input { color: " +
    ...
    if (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") != "") {
      ...
      cR +=
        "#" +
        _id +
        " .basic-searchbar-icon-faux { width: " +
        prx.componentsHelper.getProp(item.textSize, "num-text-size") +
        "px;}";
    }
    cR +=
      "#" +
      _id +
      " .basic-searchbar-input-flex { background: " +
      prx.componentsHelper.getProp(item.backgroundColor, "color-background") +
      "; border-width: " +
      prx.componentsHelper.getProp(item.borderWidth, "border-width") +
      "; border-style: " +
    ...
    cR +=
      "#" +
      _id +
      " .basic-searchbar-input-flex input { text-align: " +
      (prx.componentsHelper.getProp(item.textAlign, "align") === "right"
        ? "right"
        : "left") +
      " }";
    cR +=
      "#" +
      _id +
      " .basic-searchbar-icon-erase { width: " +
      _dims.height * 0.4 +
      "px; background-image: url(" +
      prx.componentsHelper.getProp(item.imgSrc2, "asset") +
      "); color: " +
      prx.componentsHelper.getProp(item.placeholderColor, "color-text") +
      ";}";
    cR += "</style>";
    ...
    if (prx.editor) {
      cR +=
        '<div class="basic-searchbar-input-flex liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color liveUpdate-borderWidth-border-width changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius">';
      if (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") != "") {
        cR += '<span class="basic-searchbar-icon-faux"></span>';
      }
      cR +=
        '<div class="basic-searchbar-faux-input liveUpdate-textColor-color changeProperty-textColor changeProperty-textSize changeProperty-textFont" data-editableproperty="value">' +
        prx.componentsHelper.getProp(item.value, "text") +
        "</div>";
      cR +=
        '<div class="basic-searchbar-faux-input-overlay liveUpdate-backgroundColor-background-color">' +
        (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") != ""
          ? '<span class="basic-searchbar-icon"></span>'
          : "") +
        '<span class="liveUpdate-placeholderColor-color placeholder-input">' +
      ...
      cR +=
        '<input autocomplete="new-password" data-lpignore="true" type="text" value="' +
        prx.componentsHelper.getProp(item.value, "other") +
        '" data-role="none" required class="real-input changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textAlign" />';
      cR +=
        '<div class="basic-searchbar-input-overlay">' +
        (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") != ""
          ? '<span class="basic-searchbar-icon"></span>'
          : "") +
        '<span class="placeholder-input changeProperty-textFont changeProperty-textSize changeProperty-textAlign">' +
        prx.componentsHelper.getProp(item.placeholder, "other") +
        "</span></div>";
      cR += '<span class="basic-searchbar-icon-erase"></span>';
      cR += "</div>";
  ...
  onResize: function (item, containerid, symbol) {
    ...
    if (prx.componentsHelper.getProp(item.imgSrc.fileId, "other") != "") {
      $(
        "#" +
          _id +
          " .basic-searchbar-icon, #" +
          _id +
          " .basic-searchbar-icon-faux"
      ).css(
        "width",
        prx.componentsHelper.getProp(item.textSize, "num-text-size") + "px"
      );
    }
    $("#" + _id)
      .find(".basic-searchbar-icon-erase")
      .css("width", _dims.height * 0.4 + "px");
    $("#" + _id)
      .find(".basic-searchbar-faux-input")
      .css("line-height", _dims.height + "px");
  },
  afterDisplay: function (item, containerid, symbol) {
    var _id = !containerid ? item.id : containerid + "-" + item.id;
    var _dims = prx.componentsHelper.getRealDims(item, symbol);
    ...
    if (!prx.editor) {
      $("#" + _id)
        ...
        .on("input", function (e) {
          if ($(this).val() == "") {
            $("#" + _id + " input + div .placeholder-input").css(
              "display",
              "block"
            );
          } else {
      ...
      $("#" + _id + " .basic-searchbar-icon-erase")
        .hammer()
        .on("tap", function () {
          $("#" + _id + " .real-input")
            .val("")
        ...
        [
          {
            ...
            type: "gradients-colorpicker",
            value: function (item, name) {
              return typeof item.backgroundColor == "undefined"
                ? ""
                : item.backgroundColor;
            },
            liveUpdate: "background-color",
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                let cssSelector =
                  "#" +
                  id +
                  " .basic-searchbar-input-overlay .placeholder-input";

                if (prx.editor) {
                  $("#" + id + " .basic-searchbar-faux-input").text(
                    prx.componentsHelper.getProp(item.placeholder, "other")
                  );
                } else {
                  $(cssSelector).text(
              ...
              changeFunction(item, containerid) {
                ...
                if (prx.editor) {
                  prx.componentsHelper.addStyleForChangeFunction(
                    ...
                    id + "-placeholderColor",
                    cssSelector +
                      " .basic-searchbar-input-flex .basic-searchbar-faux-input-overlay .placeholder-input",
                    "color",
                  ...
                  prx.componentsHelper.addStyleForChangeFunction(
                    ...
                    id + "-placeholderColor",
                    cssSelector +
                      " .basic-searchbar-input-flex .basic-searchbar-faux-input",
                    "color",
                    item.placeholderColor,
                    "color-text"
                  );
...
prx.types.basic_progressbar = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-basic-progressbar">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR +=
      "#" +
    ...
    cR +=
      "#" +
      _id +
      " .progressbar-bar-filled { width: " +
      prx.componentsHelper.getProp(item.progress, "num-percetage") +
      "%; background: " +
    ...
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      '<div class="progressbar-bar bar liveUpdate-barColor-background-color">';
    cR +=
      '<div class="progressbar-bar-filled bar liveUpdate-fillBarColor-background-color"></div>';
    cR += "</div>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
    return cR;
...
prx.types.basic_circularprogressbar = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var strokeOffset =
      ((size - strokeWidth) * Math.PI * (100 - item.progress)) / 100;
    ...
    cR +=
      ...
      '" class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-circularprogressbar " +
      (item.loader ? "type-basic-loader" : "") +
      '">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR +=
    ...
    cR +=
      " #" +
      _id +
      " .circularprogressbar .circularprogressbar-bar {fill: none; stroke: " +
      prx.componentsHelper.getProp(item.barColor, "color-background") +
      "; stroke-width: " +
      strokeWidth +
      ";}";
    cR +=
      " #" +
      _id +
      " .circularprogressbar .circularprogressbar-bar-filled {fill: none; stroke: " +
      prx.componentsHelper.getProp(item.fillBarColor, "color-fill") +
      "; stroke-dasharray: " +
      strokeDash +
      " " +
    ...
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    cR +=
      '<svg class="circularprogressbar" xmlns="http://www.w3.org/2000/svg" viewBox="-' +
      strokeWidth +
      " -" +
      strokeWidth +
      " " +
    ...
    cR +=
      ...
      (size / 2 - strokeWidth) +
      '" r="' +
      ((size - strokeWidth) / 2 > 0 ? (size - strokeWidth) / 2 : 0) +
      '" class="circularprogressbar-bar liveUpdate-barColor-stroke liveUpdate-strokeWidth-stroke-width" />';
    cR +=
      '<circle cx="' +
      (size / 2 - strokeWidth) +
      '" cy="' +
      ...
      '" r="' +
      ((size - strokeWidth) / 2 > 0 ? (size - strokeWidth) / 2 : 0) +
      '" class="circularprogressbar-bar-filled liveUpdate-fillBarColor-stroke liveUpdate-strokeWidth-stroke-width" />';
    cR += "</svg>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
    return cR;
  ...
  onResize: function (item, containerid, symbol) {
    ...
    $("#" + id + " .circularprogressbar")
      ...
      .attr(
        "viewBox",
        "-" + strokeWidth + " -" + strokeWidth + " " + size + " " + size
      );
    ...
    $("#" + id + " .circularprogressbar .circularprogressbar-bar-filled").css({
...
//TYPE: BASIC LOADER
prx.types.basic_loader = prx.componentsHelper.cloneobject(
  prx.types.basic_circularprogressbar
);
prx.types.basic_loader.name = "basic_loader";
prx.componentsHelper.removeProperties(prx.types.basic_loader.propertyGroups, [
  "progress",
]);
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var _props =
      typeof prx.richtext == "undefined"
        ...
        : "";
    var text =
      '<div class="basic-radiobutton-text liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textSize changeProperty-textProperties"><span data-editableproperty="text">' +
      prx.componentsHelper.getProp(item.text, "text-textarea") +
      "</span></div>";
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-basic-radiobutton">';
    ...
    cR +=
      "#" +
      _id +
      " label { height: 100%; width: 100%; line-height: " +
      item.textSize +
      "px;}";
    cR +=
      "#" +
      _id +
      " label .basic-radiobutton-text { word-wrap: break-word; width: calc(100% - " +
      parseInt(item.radiobuttonSize, 10) +
      "px - " +
      12 * prx.componentsHelper.getScale(item.lib) +
      "px); margin-left: " +
      (parseInt(item.radiobuttonSize, 10) +
    ...
    cR +=
      "#" +
      _id +
      " label .bordered-circle { position: absolute; top: " +
      (item.textSize - item.radiobuttonSize) / 2 +
      "px; width: " +
      item.radiobuttonSize +
      "px; height: " +
      item.radiobuttonSize +
      "px; max-width: " +
      item.radiobuttonSize +
    ...
    cR +=
      "#" +
      _id +
      " label .bordered-circle .circle { background-color: " +
      prx.componentsHelper.getProp(item.activeColor, "color-background") +
      "; }";
    cR +=
      "#" +
      _id +
      " input:checked + label .bordered-circle .circle {  width: 50%; height: 50%; margin-top: -25%; margin-left: -25%; background: " +
      prx.componentsHelper.getProp(item.activeColor, "color-background") +
      ";}";
    cR += "</style>";
    cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
    ...
    cR +=
      '<label for="' +
      _id +
      '-checkbox"><div class="bordered-circle liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color liveUpdate-borderWidth-border-width changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderWidth">';
    cR +=
      '<div class="circle liveUpdate-activeColor-background-color changeProperty-activeColor"></div>';
    cR += "</div>";
    cR += text;
    cR += "</label>";
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
...
prx.types.basic_select = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    var _dims = prx.componentsHelper.getRealDims(item, symbol);
    var activeTop =
      parseInt(item.dropdownTextSize, 10) > parseInt(_dims.height, 10)
        ? (parseInt(_dims.height, 10) - parseInt(item.dropdownTextSize, 10)) /
            2 -
          item.selected * parseInt(item.dropdownTextSize, 10) -
          parseInt(item.dropdownBorderWidth, 10) -
          8 * prx.componentsHelper.getScale(item.lib)
        : -8 * prx.componentsHelper.getScale(item.lib) -
          item.selected * parseInt(_dims.height, 10) -
          parseInt(item.dropdownBorderWidth, 10);
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-basic-select liveUpdate-textColor-color">';
    ...
    cR +=
      "#" +
      _id +
      " .basic-select-contextmenu { " +
      prx.componentsHelper.getProp(
        item.dropdownTextFont + "|" + item.dropdownTextFontStyle,
        "font-family"
      ) +
      prx.componentsHelper.getProp(item.dropdownTextFontStyle, "font-style") +
      " " +
      prx.componentsHelper.getProp(item.dropdownTextProperties, "props-text") +
      " color: " +
      prx.componentsHelper.getProp(item.dropdownTextColor, "color-text") +
      "; font-size: " +
      prx.componentsHelper.getProp(item.dropdownTextSize, "num-text-size") +
      "px; text-align: " +
      prx.componentsHelper.getProp(item.dropdownTextAlign, "align") +
      " }";
    cR +=
      "#" +
      _id +
    ...
    cR +=
      "#" +
      _id +
      " .basic-select-contextmenu { top: " +
      activeTop +
      "px; border: " +
      prx.componentsHelper.getProp(
        item.dropdownBorderWidth,
        "num-border-width"
      ) +
      "px " +
      prx.componentsHelper.getProp(item.dropdownBorderStyle, "border-type") +
      " " +
      prx.componentsHelper.getProp(item.dropdownBorderColor, "color-border") +
      "; " +
      prx.gradients.getBgCssByProperty(
        item.dropdownBackgroundColor,
        "color-background"
      ) +
      "; border-radius: " +
      prx.componentsHelper.getProp(item.dropdownBorderRadius, "border-radius") +
      "}";
    cR +=
      "#" +
      _id +
      " .basic-select-item {line-height: " +
      item.dropdownTextSize +
      "px; min-height: " +
      _dims.height +
      "px;}";
    cR +=
      "#" +
      _id +
      " .select-trigger-icon { width: " +
      _dims.height +
      "px; background-image: url(" +
      prx.componentsHelper.getProp(item.buttonicon, "asset") +
      "); line-height: " +
      (prx.componentsHelper.getProp(_dims.height, "num-other") -
        prx.componentsHelper.getProp(item.borderWidth, "num-border-width") *
          2) +
    ...
    if (!prx.editor) {
      cR +=
        "#" +
        _id +
        " .basic-select-item:hover {" +
        prx.gradients.getBgCssByProperty(
          item.dropdownHoverBackgroundColor,
          "color-background"
        ) +
        " }";
    } else {
    ...
    cR +=
      '<div class="select-trigger liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderWidth changeProperty-borderStyle changeProperty-borderRadius changeProperty-textAlign">';
    cR +=
      '<span class="basic-select-active-value changeProperty-textColor liveUpdate-textColor-color changeProperty-textSize changeProperty-textFont changeProperty-textFontStyle changeProperty-textProperties">';
    cR +=
      typeof item.buttons[item.selected] != "undefined"
        ? prx.componentsHelper.getProp(
            item.buttons[item.selected].text,
            "text-textarea"
          )
        : typeof item.buttons[0] != "undefined"
        ? prx.componentsHelper.getProp(item.buttons[0].text, "text-textarea")
        : "";
    cR += "</span>";
    cR += '<div class="select-trigger-icon"></div>';
    cR += "</div>";
    cR +=
      '<div class="basic-select-contextmenu changeProperty-dropdownBackgroundColor liveUpdate-dropdownBackgroundColor-background-color liveUpdate-dropdownBorderColor-border-color">';
    $.each(item.buttons, function (i, elm) {
      cR +=
        '<div class="basic-select-item dynamic-property changeProperty-dropdownTextFont changeProperty-dropdownTextColor changeProperty-dropdownTextFontStyle changeProperty-dropdownTextSize changeProperty-dropdownTextAlign changeProperty-dropdownTextProperties ' +
        (item.selected == i
          ? "active liveUpdate-dropdownHoverBackgroundColor-background-color"
          : "") +
        '" data-dynamic-property-index="' +
        i +
        '" id="' +
      ...
      cR +=
        ...
        prx.componentsHelper.getProp(item.dropdownActiveIcon, "asset") +
        '"></div>';
      cR +=
        '<div class="error-msg"><span data-editableproperty="text" data-dynamic-property-index="' +
        i +
        '">' +
        prx.componentsHelper.getProp(elm.text, "text-textarea") +
        "</span></div>";
    ...
    if (!prx.editor) {
      ...
      $("#" + _id + " .select-trigger")
        ...
        .on("tap", function () {
          ...
          if (!$("#" + _id + selector).is(":visible")) {
            prx.helper.toggleDropdownOptions(
              false,
              "#" + _id,
              "#" + _id + selector
            );
      ...
      $("#" + _id + " .basic-select-item")
        ...
        .on("tap", function (e) {
          ...
          let activeText = prx.currentPlayerStatus.helper.get(_id, "buttons")[
            activeSelection
          ].text;
          ...
          var activeTop =
            parseInt(item.dropdownTextSize, 10) > parseInt(_dims.height, 10)
              ? (parseInt(_dims.height, 10) -
                  parseInt(item.dropdownTextSize, 10)) /
                  2 -
                selected * parseInt(item.dropdownTextSize, 10) -
                parseInt(item.dropdownBorderWidth, 10) -
                8 * prx.componentsHelper.getScale(item.lib)
              : -8 * prx.componentsHelper.getScale(item.lib) -
                selected * parseInt(_dims.height, 10) -
                parseInt(item.dropdownBorderWidth, 10);
        ...
        [
          {
            ...
            type: "combo-select",
            value: function (item, name) {
              return item.dropdownBorderWidth;
            },
            values: { min: 0, max: 20, step: 1 },
            changeProperty: {
          ...
          },
          {
            ...
            type: "solid-colorpicker",
            value: function (item, name) {
              return item.dropdownBorderColor;
            },
            values: prx.comps.basicColors,
            liveUpdate: "border-color",
            changeProperty: {
        ...
        [
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                let id = !containerid ? item.id : containerid + "-" + item.id;
                let cssSelector =
                  "#" + id + " .basic-select-item .image > img ";

                prx.componentsHelper.changeImageForChangeFunction(
                  cssSelector,
                  item.dropdownActiveIcon
                );
              },
            },
          },
      ...
      properties: [
        [
          {
            ...
            relatedCSSProperties: "font-family",
            value: function (item, name) {
              if (typeof item.dropdownTextFont == "undefined") {
                item.dropdownTextFont = "Arial,sans-serif";
              }
        ...
        [
          {
            ...
            value: function (item, name) {
              return typeof item.dropdownTextFontStyle == "undefined"
                ? ""
                : item.dropdownTextFontStyle;
            },
            values: function () {
          ...
          },
          {
            ...
            relatedCSSProperties: "font-size",
            value: function (item, name) {
              if (typeof item.dropdownTextSize == "undefined") {
                item.dropdownTextSize = 16;
              }
        ...
        [
          prx.commonproperties.textPropertiesRichText(
            ...
            false,
            {
              propName: "dropdownTextProperties",
              caption: "Popover underline",
              useAsDynProp: false,
            }
          ),
          {
              ...
              changeFunction(item, containerid) {
                ...
                $.each(items, function (index, _item) {
                  ...
                  if (index === parseInt(item.selected)) {
                    ...
                    $("#" + id)
                      .find(".basic-select-active-value")
...
prx.types.basic_dropdown = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-dropdown liveUpdate-textColor-color position-dropdown-" +
      _position +
      ' ">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    ...
    cR +=
      "#" +
      _id +
      " .basic-dropdown-contextmenu { width: fit-content; margin-top: 5px; border: " +
      prx.componentsHelper.getProp(
        item.dropdownBorderWidth,
        "num-border-width"
      ) +
    ...
    cR +=
      ...
      prx.gradients.getBgCssByProperty(
        item.hoverInactiveBackgroundColor,
        "color-background"
      ) +
      "; color: " +
      prx.componentsHelper.getProp(item.hoverInactiveTextColor, "color-text") +
      "; }";
    cR +=
      "#" +
      _id +
      " .basic-dropdown-item.active:hover { " +
      prx.gradients.getBgCssByProperty(
        item.hoverActiveBackgroundColor,
        "color-background"
      ) +
      "; color: " +
      prx.componentsHelper.getProp(item.hoverActiveTextColor, "color-text") +
      "; }";
    cR +=
      "#" +
      _id +
      " .active { color: " +
      prx.componentsHelper.getProp(item.dropdownActiveTextColor, "color-text") +
      "; " +
      prx.gradients.getBgCssByProperty(
        item.dropdownActiveBackgroundColor,
        "color-background"
      ) +
      " }";
    cR += "</style>";
    ...
    cR +=
      '<div class="dropdown-trigger liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-borderRadius">';
    cR +=
      '<div class="basic-dropdown-active-value changeProperty-textColor liveUpdate-textColor-color changeProperty-textSize changeProperty-textFont changeProperty-textFontStyle changeProperty-textProperties changeProperty-textAlign">';
    cR +=
    ...
    cR +=
      '<div class="basic-dropdown-contextmenu liveUpdate-dropdownBackgroundColor-background-color liveUpdate-dropdownBorderColor-border-color liveUpdate-dropdownTextColor-color changeProperty-dropdownTextColor">';
    $.each(item.buttons, function (i, elm) {
      cR +=
        '<div class="basic-dropdown-item dynamic-property changeProperty-dropdownTextFont changeProperty-dropdownTextColor changeProperty-dropdownTextFontStyle changeProperty-dropdownTextSize changeProperty-dropdownTextAlign changeProperty-dropdownTextProperties ' +
        (item.selected == i
          ? "active liveUpdate-dropdownTextColor-color liveUpdate-dropdownActiveBackgroundColor-background-color"
          : "") +
        '" data-dynamic-property-index="' +
        i +
        '" id="' +
          ...
          },
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-border-color-2-active",
                  cssSelector,
                  "border-color",
                  item.dropdownBorderColor,
                  "color-border"
                );
              },
            },
        ...
        [
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-hoverInactiveBackgroundColor",
                  cssSelector,
                  "background-color",
                  item.hoverInactiveBackgroundColor,
                  "color-background"
          ...
          },
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-hoverInactiveTextColor",
                  cssSelector,
                  "color",
                  item.hoverInactiveTextColor,
                  "color-text"
                );
              },
            },
        ...
        [
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                let id = !containerid ? item.id : containerid + "-" + item.id;
                let cssSelector =
                  "#" + id + " .basic-dropdown-item.active:hover";

                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-hoverActiveBackgroundColor",
                  cssSelector,
                  "background-color",
                  item.hoverActiveBackgroundColor,
                  "color-background"
          ...
          },
          {
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-hoverActiveTextColor",
                  cssSelector,
                  "color",
                  item.hoverActiveTextColor,
                  "color-text"
                );
              },
            },
  ...
  editableProperties: [
    {
      ...
      changeProperty: {
        ...
        changeFunction(item, containerid) {
          let id = !containerid ? item.id : containerid + "-" + item.id;
          let cssSelector =
            "#" + id + " .dropdown-trigger .basic-dropdown-active-value";
    ...
    editableProperties: [
      {
        ...
        changeProperty: {
          ...
          changeFunction(item, containerid) {
            let id = !containerid ? item.id : containerid + "-" + item.id;
            let cssSelector =
              "#" + id + " .basic-dropdown-item .error-msg span";
...
prx.types.basic_pagecontroller = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      ' box pos type-basic-pagecontroller">';
    ...
    cR +=
      "#" +
      _id +
      " .basic-pagecontroller-button label { background: " +
      prx.componentsHelper.getProp(item.backgroundColor, "color-background") +
      "; border-radius: " +
      prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
      "; width: " +
    ...
    cR +=
      "#" +
      _id +
      " .basic-pagecontroller-button input:checked + label { transform: scale(" +
      item.activeSize +
      "); background: " +
      prx.componentsHelper.getProp(
        item.activeBackgroundColor,
    ...
    $.each(item.buttons, function (i, elm) {
      cR +=
        '<div class="basic-pagecontroller-button dynamic-property" data-dynamic-property-index="' +
        i +
        '" id="' +
        _id +
        "-buttons-" +
      ...
      cR +=
        ...
        (prx.componentsHelper.getProp(item.selected, "num-other") == i
          ...
          : "") +
        ' data-role="none" ' +
        (!prx.componentsHelper.getProp(item.changeActive, "num-other")
          ? "disabled"
          : "") +
        ">";
      cR +=
        ...
        "-radio-" +
        i +
        '" class="changeProperty-borderRadius ' +
        (prx.componentsHelper.getProp(item.selected, "num-other") == i
          ? "changeProperty-activeBackgroundColor liveUpdate-activeBackgroundColor-background"
          : "changeProperty-backgroundColor liveUpdate-backgroundColor-background") +
        '" ></label>';
      cR += "</div>";
    });
    cR += "</div>";
  ...
  propertyGroups: [
    {
      ...
      properties: [
            ...
            changeProperty: {
              ...
              changeFunction(item, containerid) {
                ...
                let cssSelector =
                  "#" +
                  id +
                  " .basic-pagecontroller-button input:checked + label";

                prx.componentsHelper.addStyleForChangeFunction(
                  id,
                  id + "-activeButtonScale",
                  cssSelector,
                  "transform",
                  "scale(" + item.activeSize + ")",
                  "other"
                );
              },
            },
        ...
        [
          {
            caption:
              'Border <span class="icon icon-border-radius" title="Border radius"></span>',
            name: "borderRadius",
            proptype: "border-radius",
            type: "combo-select",
            value: function (item, name) {
              ...
              changeFunction(item, containerid) {
                item.buttons.forEach(function (button, idx) {
                  ...
                  let cssSelector =
                    "#" +
                    id +
                    " .basic-pagecontroller-button input" +
                    "#" +
                    id +
                    "-radio-" +
                    idx;
...
prx.types.basic_textfield = {
  ...
  onDisplay: function (item, containerid, symbol) {
    ...
    cR +=
      ...
      ' class="' +
      prx.items.getComponentBaseClasses(item, containerid, symbol) +
      " box pos type-basic-textfield type-basic-textfield-" +
      prx.componentsHelper.getProp(item.inputtype, "text-other") +
      '">';
    cR += "<style>";
    cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
    cR +=
      ...
      prx.componentsHelper.getProp(item.borderWidth, "border-width") +
      "; border-style: " +
      prx.componentsHelper.getProp(item.borderStyle, "border-style") +
      "; border-color: " +
      prx.componentsHelper.getProp(item.borderColor, "color-border") +
      "; border-radius: " +
      prx.componentsHelper.getProp(item.borderRadius, "border-radius") +
    ...
    if (prx.editor) {
      cR +=
        '<div class="faux-input liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-borderStyle-border-style liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius changeProperty-textAlign" data-editableproperty="value">' +
        prx.componentsHelper.getProp(item.value, "text") +
        "</div>";
      cR +=
        '<div class="faux-input placeholder-input liveUpdate-placeholderColor-color liveUpdate-borderColor-border-color liveUpdate-borderStyle-border-style liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius changeProperty-textAlign">' +
        prx.componentsHelper.getProp(item.placeholder, "other") +
        "</div>";
    } else {
      cR +=
        ...
        '" placeholder="' +
        prx.componentsHelper.getProp(item.placeholder, "other") +
        '" data-role="none" class="real-input changeProperty-backgroundColor changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius changeProperty-textAlign" />';
    }
    cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    cR += "</div>";
    return cR;
...
prx.components.basic_button_texticon = {
  ...
  img: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1424098557988/78855ffe7a4c9efea4291339339586d3.svg",
    targetSrc: "generated/04fc9053132a2832640e4ab5705f5ab5_ffffff.svg",
    color: "ffffff",
  },
};
...
prx.components.basic_checkbox = {
  ...
  img: {
    ...
    targetSrc: "generated/34d6599607c21d5f87e5d30af9449c1c_ffffff.svg",
    color: "ffffff",
  },
  active: true,
  radioButtonsGroupName: "",
...
prx.components.basic_buttongroup = {
  ...
  helper:
    prx.url.devices +
    "/generic2/basic_buttongroup_horizontal_texticon_right/helper.png",
  width: 320 * prx.componentsHelper.getScale(_library),
  height: 40 * prx.componentsHelper.getScale(_library),
  resizable: true,
  backgroundColor: "rgba(0,0,0,0)",
  ...
  buttons: [
    {
      ...
      icon: {
        ...
        targetSrc: "generated/324879579bf3ecf9c4b49ef0c151501b_6c7075.svg",
        color: "6c7075",
      },
      activeicon: {
        fileId: "324879579bf3ecf9c4b49ef0c151501b.svg",
        ...
        bucketsource: "static",
        url: "f1352971179296/693bf32e7424f6bf747696ddab19cdf5.svg",
        targetSrc: "generated/324879579bf3ecf9c4b49ef0c151501b_ffffff.svg",
        color: "ffffff",
      },
      text: "First",
    },
    {
      actions: [],
      icon: {
        fileId: "f46effc9d8189665443ebcc0f7ca0934.svg",
        name: "heart.svg",
        assetType: "icon",
        bucketsource: "static",
        url: "f1515489068744/f46effc9d8189665443ebcc0f7ca0934.svg",
        targetSrc: "generated/f46effc9d8189665443ebcc0f7ca0934_6c7075.svg",
        color: "6c7075",
      },
      activeicon: {
        fileId: "f46effc9d8189665443ebcc0f7ca0934.svg",
        ...
        bucketsource: "static",
        url: "f1515489068744/f46effc9d8189665443ebcc0f7ca0934.svg",
        targetSrc: "generated/f46effc9d8189665443ebcc0f7ca0934_ffffff.svg",
        color: "ffffff",
      },
      text: "Second",
    },
...
prx.components.basic_buttongroup_horizontal_text = {
  ...
  iconSize: "3",
  helper:
    prx.url.devices + "/generic2/basic_buttongroup_horizontal_text/helper.png",
  width: 320 * prx.componentsHelper.getScale(_library),
  height: 40 * prx.componentsHelper.getScale(_library),
  resizable: true,
  backgroundColor: "rgba(0,0,0,0)",
...
prx.components.basic_buttongroup_horizontal_texticon_top = {
  ...
  helper:
    prx.url.devices +
    "/generic2/basic_buttongroup_horizontal_texticon_top/helper.png",
  width: 320 * prx.componentsHelper.getScale(_library),
...
prx.components.basic_buttongroup_horizontal_icon = {
  ...
  iconSize: "2",
  helper:
    prx.url.devices + "/generic2/basic_buttongroup_horizontal_icon/helper.png",
  width: 320 * prx.componentsHelper.getScale(_library),
  height: 40 * prx.componentsHelper.getScale(_library),
  resizable: true,
  backgroundColor: "rgba(0,0,0,0)",
...
prx.components.basic_buttongroup_vertical_text = {
  ...
  iconSize: "3",
  helper:
    prx.url.devices + "/generic2/basic_buttongroup_vertical_text/helper.png",
...
prx.components.basic_buttongroup_vertical_texticon = {
  ...
  helper:
    prx.url.devices +
    "/generic2/basic_buttongroup_vertical_texticon/helper.png",
  width: 160 * prx.componentsHelper.getScale(_library),
  height: 80 * prx.componentsHelper.getScale(_library),
  resizable: true,
  backgroundColor: "rgba(0,0,0,0)",
...
prx.components.basic_buttongroup_vertical_icon = {
  ...
  iconSize: "2",
  helper:
    prx.url.devices + "/generic2/basic_buttongroup_vertical_icon/helper.png",
  width: 160 * prx.componentsHelper.getScale(_library),
  height: 80 * prx.componentsHelper.getScale(_library),
  resizable: true,
  backgroundColor: "rgba(0,0,0,0)",
...
prx.components.basic_checkbox_list_horizontal = {
  ...
  inactiveicon: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1447836421086/dd615595951ee619d2e0b0135cadeeba.svg",
    targetSrc: "generated/dd615595951ee619d2e0b0135cadeeba_d4d7d9.svg",
    color: "d4d7d9",
  },
  activeicon: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1447836421086/6c2575641c6ad1c8f5278ea330084ff0.svg",
    targetSrc: "generated/6c2575641c6ad1c8f5278ea330084ff0_0076ff.svg",
    color: "0076ff",
  },
  helper:
    prx.url.devices + "/generic2/basic_checkbox_list_horizontal/helper.png",
...
prx.components.basic_searchbar = {
  ...
  imgSrc: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1352971179296/14870b88002e540a4d1fc9c2d2a88384.svg",
    targetSrc: "generated/92e25d8093bef9eb0ec44968eff32c0f_6c7075.svg",
    color: "6c7075",
  },
  imgSrc2: {
    ...
    targetSrc: "generated/e648f99b268782f39ea1442529369aa3_6c7075.svg",
    color: "6c7075",
  },
};
...
prx.components.basic_select = {
  ...
  dropdownActiveIcon: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1424098557988/34d6599607c21d5f87e5d30af9449c1c.svg",
    targetSrc: "generated/e55a24db51c6e010c487864432e3d456_6c7075.svg",
    color: "6c7075",
  },
  ...
  buttonicon: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1424098557988/f2496f33c0227f602f3f15f19eec30aa.svg",
    targetSrc: "generated/5be0df1935f57ae652c04aa0cb25f50e_6c7075.svg",
    color: "6c7075",
  },
  buttons: [
    {
...
prx.components.basic_dropdown = {
  ...
  buttonicon: {
    ...
    assetType: "icon",
    bucketsource: "static",
    url: "f1424098425738/f9a2843ca34c5ec824da30d7a887f664.svg",
    targetSrc: "generated/185f3be0c18a065efec6e893e0a6ce94_6c7075.svg",
    color: "6c7075",
  },
  buttons: [
    {
